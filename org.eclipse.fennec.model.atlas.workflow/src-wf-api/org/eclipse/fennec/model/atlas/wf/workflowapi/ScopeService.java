 ...
 *
 * <!-- begin-model-doc --> Orchestrates all data operations for this scope by
 * validating and delegating to RegistryService. <!-- end-model-doc -->
 *
 *
...
public interface ScopeService<T extends EObject> {
     ...
     * @generated
     */
    Promise<ObjectMetadata> updateInStageForRegistry(String registry, String stage, T updatedObject, String objectId,
            String version);
     ...
     *        dataType="org.eclipse.fennec.model.atlas.mgmt.management.List&lt;org.eclipse.emf.ecore.EString&gt;"
     *        many="false"
     * @generated
     */
