...
public class WorkflowApiPackageImpl extends EPackageImpl implements WorkflowApiPackage {
     ...
     *
     * <p>
     * This method is used to initialize {@link WorkflowApiPackage#eINSTANCE} when
    ...
    public static WorkflowApiPackage init() {
        if (isInited)
            return (WorkflowApiPackage) EPackage.Registry.INSTANCE.getEPackage(WorkflowApiPackage.eNS_URI);

        // Obtain or create and register package
        Object registeredWorkflowApiPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
        WorkflowApiPackageImpl theWorkflowApiPackage = registeredWorkflowApiPackage instanceof WorkflowApiPackageImpl
                ? (WorkflowApiPackageImpl) registeredWorkflowApiPackage
                : new WorkflowApiPackageImpl();
    ...
    public void createPackageContents() {
        ...
        createEOperation(eObjectWorkflowServiceEClass,
                EOBJECT_WORKFLOW_SERVICE___UPLOAD_TO_STAGE_FOR_REGISTRY__STRING_STRING_EOBJECT_OBJECTMETADATA);
        createEOperation(eObjectWorkflowServiceEClass,
                EOBJECT_WORKFLOW_SERVICE___GET_FROM_STAGE_FOR_REGISTRY__STRING_STRING_STRING);
        createEOperation(eObjectWorkflowServiceEClass,
                EOBJECT_WORKFLOW_SERVICE___GET_FROM_FINAL_STAGE_FOR_REGISTRY__STRING_STRING);
        createEOperation(eObjectWorkflowServiceEClass,
                EOBJECT_WORKFLOW_SERVICE___GET_CONTENT_FROM_STAGE_FOR_REGISTRY__STRING_STRING_STRING);
        createEOperation(eObjectWorkflowServiceEClass,
                EOBJECT_WORKFLOW_SERVICE___UPDATE_IN_STAGE_FOR_REGISTRY__STRING_STRING_EOBJECT_STRING_STRING);
        createEOperation(eObjectWorkflowServiceEClass,
                EOBJECT_WORKFLOW_SERVICE___DELETE_FROM_STAGE_FOR_REGISTRY__STRING_STRING_STRING);
        createEOperation(eObjectWorkflowServiceEClass,
                EOBJECT_WORKFLOW_SERVICE___LIST_IN_STAGE_FOR_REGISTRY__STRING_STRING);
        createEOperation(eObjectWorkflowServiceEClass,
                EOBJECT_WORKFLOW_SERVICE___LIST_IN_STAGE_FOR_REGISTRY_BY_NAME__STRING_STRING_STRING);
        createEOperation(eObjectWorkflowServiceEClass,
                EOBJECT_WORKFLOW_SERVICE___LIST_IN_FINAL_STAGE_FOR_REGISTRY__STRING);
        createEOperation(eObjectWorkflowServiceEClass,
                EOBJECT_WORKFLOW_SERVICE___TRANSITION_TO_STAGE_FOR_REGISTRY__STRING_STRING_STRING_STRING);
        ...
        createEOperation(registryServiceEClass,
                REGISTRY_SERVICE___UPLOAD_TO_STAGE__STRING_STRING_EOBJECT_OBJECTMETADATA);
        ...
        createEOperation(registryServiceEClass,
                REGISTRY_SERVICE___UPDATE_IN_STAGE__STRING_STRING_EOBJECT_STRING_STRING);
        ...
        createEOperation(scopeServiceEClass,
                SCOPE_SERVICE___UPLOAD_TO_STAGE_FOR_REGISTRY__STRING_STRING_EOBJECT_OBJECTMETADATA);
        createEOperation(scopeServiceEClass,
                SCOPE_SERVICE___GET_METADATA_FROM_STAGE_FOR_REGISTRY__STRING_STRING_STRING);
        ...
        createEOperation(scopeServiceEClass,
                SCOPE_SERVICE___UPDATE_IN_STAGE_FOR_REGISTRY__STRING_STRING_EOBJECT_STRING_STRING);
        ...
        createEOperation(scopeServiceEClass,
                SCOPE_SERVICE___TRANSITION_TO_STAGE_FOR_REGISTRY__STRING_STRING_STRING_STRING);
    ...
    public void initializePackageContents() {
        ...
        initEClass(eObjectWorkflowServiceEClass, EObjectWorkflowService.class, "EObjectWorkflowService", IS_ABSTRACT,
                IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        EOperation op = initEOperation(
                getEObjectWorkflowService__UploadToStageForRegistry__String_String_EObject_ObjectMetadata(), null,
                "uploadToStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectWorkflowService__GetFromStageForRegistry__String_String_String(),
                theManagementPackage.getObjectMetadata(), "getFromStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getEObjectWorkflowService__GetFromFinalStageForRegistry__String_String(),
                theManagementPackage.getObjectMetadata(), "getFromFinalStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getEObjectWorkflowService__GetContentFromStageForRegistry__String_String_String(), null,
                "getContentFromStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(eObjectWorkflowServiceEClass_T);
        ...
        op = initEOperation(getEObjectWorkflowService__UpdateInStageForRegistry__String_String_EObject_String_String(),
                null, "updateInStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(eObjectWorkflowServiceEClass_T);
        ...
        op = initEOperation(getEObjectWorkflowService__DeleteFromStageForRegistry__String_String_String(), null,
                "deleteFromStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getPromise());
        ...
        op = initEOperation(getEObjectWorkflowService__ListInStageForRegistry__String_String(), null,
                "listInStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectWorkflowService__ListInStageForRegistryByName__String_String_String(), null,
                "listInStageForRegistryByName", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectWorkflowService__ListInFinalStageForRegistry__String(), null,
                "listInFinalStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getList());
        g2 = createEGenericType(theManagementPackage.getObjectMetadata());
        g1.getETypeArguments().add(g2);
        ...
        op = initEOperation(getEObjectWorkflowService__TransitionToStageForRegistry__String_String_String_String(),
                theManagementPackage.getObjectMetadata(), "transitionToStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectWorkflowService__IsTransitionAllowed__String_String(), ecorePackage.getEBoolean(),
                "isTransitionAllowed", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "fromStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "toStage", 0, 1, IS_UNIQUE, IS_ORDERED);

        initEClass(registryServiceEClass, RegistryService.class, "RegistryService", IS_ABSTRACT, IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);

        op = initEOperation(getRegistryService__UploadToStage__String_String_EObject_ObjectMetadata(), null,
                "uploadToStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getRegistryService__GetMetadataFromStage__String_String_String(),
                theManagementPackage.getObjectMetadata(), "getMetadataFromStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getRegistryService__GetMetadataFromFinalStage__String_String(),
                theManagementPackage.getObjectMetadata(), "getMetadataFromFinalStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getRegistryService__GetContentFromStage__String_String_String(), null,
                "getContentFromStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(eObjectWorkflowServiceEClass_T);
        ...
        op = initEOperation(getRegistryService__UpdateInStage__String_String_EObject_String_String(), null,
                "updateInStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(eObjectWorkflowServiceEClass_T);
        addEParameter(op, g1, "updatedObject", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getRegistryService__DeleteFromStage__String_String_String(), null, "deleteFromStage", 0, 1,
        ...
        op = initEOperation(getRegistryService__ListInStage__String_String(), null, "listInStage", 0, 1, IS_UNIQUE,
                IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getList());
        ...
        op = initEOperation(getRegistryService__ListInStageByName__String_String_String(), null, "listInStageByName", 0,
        ...
        op = initEOperation(getRegistryService__ListInFinalStage__String(), null, "listInFinalStage", 0, 1, IS_UNIQUE,
                IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getList());
        g2 = createEGenericType(theManagementPackage.getObjectMetadata());
        ...
        op = initEOperation(getRegistryService__TransitionToStage__String_String_String_String(),
                theManagementPackage.getObjectMetadata(), "transitionToStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "fromStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "toStage", 0, 1, IS_UNIQUE, IS_ORDERED);

        initEOperation(getRegistryService__GetRegistryName(), ecorePackage.getEString(), "getRegistryName", 0, 1,
                IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getRegistryService__IsValidStage__String(), ecorePackage.getEBoolean(), "isValidStage", 0,
                1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stageName", 0, 1, IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getRegistryService__IsWritableStage__String(), ecorePackage.getEBoolean(),
                "isWritableStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stageName", 0, 1, IS_UNIQUE, IS_ORDERED);

        initEOperation(getRegistryService__IsFinalStageWritable(), ecorePackage.getEBoolean(), "isFinalStageWritable",
                0, 1, IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getRegistryService__IsTransitionAllowed__String_String(), ecorePackage.getEBoolean(),
                "isTransitionAllowed", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "fromStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "toStage", 0, 1, IS_UNIQUE, IS_ORDERED);

        initEOperation(getRegistryService__GetRegistry(), this.getRegistry(), "getRegistry", 0, 1, IS_UNIQUE,
                IS_ORDERED);

        op = initEOperation(getRegistryService__IsEClassCompatibleWithRegistry__EClass(), ecorePackage.getEBoolean(),
                "isEClassCompatibleWithRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEClass(), "eClass", 0, 1, IS_UNIQUE, IS_ORDERED);

        initEOperation(getRegistryService__GetRootEClass(), ecorePackage.getEClass(), "getRootEClass", 0, 1, IS_UNIQUE,
                IS_ORDERED);

        op = initEOperation(getRegistryService__Activate__String(), theManagementPackage.getVoid(), "activate", 0, 1,
                IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 0, 1, IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getRegistryService__Deactivate__String(), theManagementPackage.getVoid(), "deactivate", 0,
                1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 0, 1, IS_UNIQUE, IS_ORDERED);

        initEClass(scopeServiceEClass, ScopeService.class, "ScopeService", IS_ABSTRACT, IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);

        op = initEOperation(getScopeService__UploadToStageForRegistry__String_String_EObject_ObjectMetadata(), null,
                "uploadToStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(eObjectWorkflowServiceEClass_T);
        ...
        op = initEOperation(getScopeService__GetMetadataFromStageForRegistry__String_String_String(),
                theManagementPackage.getObjectMetadata(), "getMetadataFromStageForRegistry", 0, 1, IS_UNIQUE,
                IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getScopeService__GetMetadataFromFinalStageForRegistry__String_String(),
                theManagementPackage.getObjectMetadata(), "getMetadataFromFinalStageForRegistry", 0, 1, IS_UNIQUE,
                IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getScopeService__GetContentFromStageForRegistry__String_String_String(), null,
                "getContentFromStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getScopeService__UpdateInStageForRegistry__String_String_EObject_String_String(), null,
                "updateInStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(eObjectWorkflowServiceEClass_T);
        addEParameter(op, g1, "updatedObject", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getScopeService__DeleteFromStageForRegistry__String_String_String(), null,
                "deleteFromStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getScopeService__ListInStageForRegistry__String_String(), null, "listInStageForRegistry", 0,
                1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getList());
        ...
        op = initEOperation(getScopeService__ListInStageForRegistryByName__String_String_String(), null,
                "listInStageForRegistryByName", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getScopeService__ListInFinalStageForRegistry__String(), null, "listInFinalStageForRegistry",
                0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getList());
        g2 = createEGenericType(theManagementPackage.getObjectMetadata());
        ...
        op = initEOperation(getScopeService__TransitionToStageForRegistry__String_String_String_String(),
                theManagementPackage.getObjectMetadata(), "transitionToStageForRegistry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "fromStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getScopeService__IsValidRegistry__String(), ecorePackage.getEBoolean(), "isValidRegistry",
                0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        initEAttribute(getStage_Writable(), ecorePackage.getEBoolean(), "writable", null, 0, 1, Stage.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStage_Final(), ecorePackage.getEBoolean(), "final", null, 0, 1, Stage.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(registryEClass, org.eclipse.fennec.model.atlas.wf.workflowapi.Registry.class, "Registry",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getRegistry_Name(), ecorePackage.getEString(), "name", null, 0, 1,
                org.eclipse.fennec.model.atlas.wf.workflowapi.Registry.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getRegistry_Description(), ecorePackage.getEString(), "description", null, 0, 1,
                org.eclipse.fennec.model.atlas.wf.workflowapi.Registry.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getRegistry_Stages(), this.getStage(), null, "stages", null, 0, -1,
                org.eclipse.fennec.model.atlas.wf.workflowapi.Registry.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getRegistry_AllowedTransitions(), this.getStageTransition(), null, "allowedTransitions", null, 0,
                -1, org.eclipse.fennec.model.atlas.wf.workflowapi.Registry.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(scopeEClass, Scope.class, "Scope", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getScope_Name(), ecorePackage.getEString(), "name", null, 0, 1, Scope.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getScope_Description(), ecorePackage.getEString(), "description", null, 0, 1, Scope.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getScope_ParentScope(), ecorePackage.getEString(), "parentScope", null, 0, 1, Scope.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getScope_Registries(), this.getRegistry(), null, "registries", null, 0, -1, Scope.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(stageTransitionEClass, StageTransition.class, "StageTransition", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getStageTransition_FromStage(), ecorePackage.getEString(), "fromStage", null, 0, 1,
                StageTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStageTransition_ToStage(), ecorePackage.getEString(), "toStage", null, 0, 1,
                StageTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
