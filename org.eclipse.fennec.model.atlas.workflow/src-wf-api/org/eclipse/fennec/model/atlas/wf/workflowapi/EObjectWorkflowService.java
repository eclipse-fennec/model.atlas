...
public interface EObjectWorkflowService<T extends EObject> {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Get the actual EObject content by ID for the final stage of a registry.  If nothing is found in that stage, the parents final stage of the same registry are also inspected. 
	 * <!-- end-model-doc -->
	 * @model objectIdRequired="true"
	 * @generated
	 */
