...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.model.atlas.wf.workflowapi\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.osgi.service.condition.Condition\"" , "uses:=org.osgi.service.condition" })
public class WorkflowApiConfigurationComponent {

	private static final System.Logger LOG = System.getLogger(WorkflowApiConfigurationComponent.class.getName());
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(WorkflowApiPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(WorkflowApiPackage.eNS_URI, ePackage);
		}
