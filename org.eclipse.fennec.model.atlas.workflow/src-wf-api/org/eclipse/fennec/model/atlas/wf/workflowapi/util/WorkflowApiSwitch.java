...
public class WorkflowApiSwitch<T1> extends Switch<T1> {
     ...
     * Workflow Service</em>'. <!-- begin-user-doc --> This implementation returns
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Registry
     * Service</em>'. <!-- begin-user-doc --> This implementation returns null;
     * returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Registry
     *         Service</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
     ...
     * '<em>Stage</em>'. <!-- begin-user-doc --> This implementation returns null;
     * returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object the target of the switch.
    ...
    /**
     * Returns the result of interpreting the object as an instance of
     * '<em>Registry</em>'. <!-- begin-user-doc --> This implementation returns
     * null; returning a non-null result will terminate the switch. <!--
     * end-user-doc -->
     * 
     * @param object the target of the switch.
    ...
    /**
     * Returns the result of interpreting the object as an instance of
     * '<em>Scope</em>'. <!-- begin-user-doc --> This implementation returns null;
     * returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of
