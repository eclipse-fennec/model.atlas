...
/**
 * Default {@link RegistryServiceCollector} implementation.
 *
 * @author ilenia
 * @since Jan 15, 2026
 */
@Component(immediate = true, name = "RegistryServiceCollector", service = RegistryServiceCollector.class)
public class RegistryServiceCollectorImpl implements RegistryServiceCollector {

    private static final Logger LOGGER = Logger.getLogger(RegistryServiceCollectorImpl.class.getName());
