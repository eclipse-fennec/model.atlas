 ...
 */
package org.eclipse.fennec.model.atlas.mgmt.api.impl;
...
import org.eclipse.fennec.model.atlas.mgmt.api.EObjectDiscoveryService;
import org.eclipse.fennec.model.atlas.mgmt.api.EObjectGenerationService;
import org.eclipse.fennec.model.atlas.mgmt.api.EObjectRegistryService;
import org.eclipse.fennec.model.atlas.mgmt.api.EObjectStorageService;
import org.eclipse.fennec.model.atlas.mgmt.api.ManagementApiFactory;
import org.eclipse.fennec.model.atlas.mgmt.api.ManagementApiPackage;
...
public class ManagementApiPackageImpl extends EPackageImpl implements ManagementApiPackage {
     ...
     * @see org.eclipse.fennec.model.atlas.mgmt.api.ManagementApiPackage#eNS_URI
     * @see #init()
     * @generated
     */
     ...
     *
     * <p>
     * This method is used to initialize {@link ManagementApiPackage#eINSTANCE} when
    ...
    public static ManagementApiPackage init() {
        if (isInited)
            return (ManagementApiPackage) EPackage.Registry.INSTANCE.getEPackage(ManagementApiPackage.eNS_URI);

        // Obtain or create and register package
        Object registeredManagementApiPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
        ManagementApiPackageImpl theManagementApiPackage = registeredManagementApiPackage instanceof ManagementApiPackageImpl
                ? (ManagementApiPackageImpl) registeredManagementApiPackage
                : new ManagementApiPackageImpl();
    ...
    public void createPackageContents() {
        ...
        createEOperation(eObjectGenerationServiceEClass,
                EOBJECT_GENERATION_SERVICE___REQUEST_GENERATION__STRING_STRING_STRING_STRING);
        createEOperation(eObjectGenerationServiceEClass,
                EOBJECT_GENERATION_SERVICE___REQUEST_GENERATION__STRING_STRING_STRING_STRING_EOBJECT);
        ...
        createEOperation(eObjectDiscoveryServiceEClass,
                EOBJECT_DISCOVERY_SERVICE___FIND_OBJECT_BY_JSON_PATTERN__STRING_STRING_STRING);
        createEOperation(eObjectDiscoveryServiceEClass,
                EOBJECT_DISCOVERY_SERVICE___SEARCH_SIMILAR_OBJECTS__STRING_STRING_DOUBLE);
        ...
        createEOperation(eObjectDiscoveryServiceEClass,
                EOBJECT_DISCOVERY_SERVICE___CACHE_GENERATION_REQUEST__STRING_STRING);
        createEOperation(eObjectDiscoveryServiceEClass,
                EOBJECT_DISCOVERY_SERVICE___REMOVE_GENERATION_REQUEST_FROM_CACHE__STRING);
        createEOperation(eObjectDiscoveryServiceEClass,
                EOBJECT_DISCOVERY_SERVICE___CACHE_OBJECT_METADATA__OBJECTMETADATA);
        createEOperation(eObjectDiscoveryServiceEClass,
                EOBJECT_DISCOVERY_SERVICE___REMOVE_OBJECT_REGISTRATION_FROM_CACHE__STRING);
        createEOperation(eObjectDiscoveryServiceEClass,
                EOBJECT_DISCOVERY_SERVICE___GET_GENERATION_REQUEST_ID_FOR_FINGERPRINT__STRING);

        eObjectStorageServiceEClass = createEClass(EOBJECT_STORAGE_SERVICE);
        createEOperation(eObjectStorageServiceEClass,
                EOBJECT_STORAGE_SERVICE___STORE_OBJECT__STRING_STRING_STRING_STRING_EOBJECT_OBJECTMETADATA);
        createEOperation(eObjectStorageServiceEClass,
                EOBJECT_STORAGE_SERVICE___UPDATE_OBJECT__STRING_EOBJECT_OBJECTMETADATA);
        createEOperation(eObjectStorageServiceEClass,
                EOBJECT_STORAGE_SERVICE___RETRIEVE_OBJECT__STRING_STRING_STRING_STRING);
        createEOperation(eObjectStorageServiceEClass,
                EOBJECT_STORAGE_SERVICE___RETRIEVE_METADATA__STRING_STRING_STRING_STRING);
        createEOperation(eObjectStorageServiceEClass,
                EOBJECT_STORAGE_SERVICE___DELETE_OBJECT__STRING_STRING_STRING_STRING);
        ...
        createEOperation(eObjectStorageServiceEClass,
                EOBJECT_STORAGE_SERVICE___UPDATE_METADATA__STRING_STRING_STRING_STRING_OBJECTMETADATA);
        createEOperation(eObjectStorageServiceEClass,
                EOBJECT_STORAGE_SERVICE___UPDATE_STATUS__STRING_STRING_STRING_STRING_OBJECTSTATUS_STRING);
        ...
        createEOperation(eObjectRegistryServiceEClass,
                EOBJECT_REGISTRY_SERVICE___FIND_BY_OBJECT_NAME_AND_STAGE__STRING_STRING);
        ...
        createEOperation(eObjectRegistryServiceEClass,
                EOBJECT_REGISTRY_SERVICE___FIND_BY_STATUS_AND_TYPE__OBJECTSTATUS_STRING);
        ...
        createEOperation(eObjectRegistryServiceEClass,
                EOBJECT_REGISTRY_SERVICE___FIND_BY_SCOPE_AND_STAGE__STRING_STRING);
        createEOperation(eObjectRegistryServiceEClass,
                EOBJECT_REGISTRY_SERVICE___FIND_BY_SCOPE_STAGE_AND_NAME__STRING_STRING_STRING);
        createEOperation(eObjectRegistryServiceEClass,
                EOBJECT_REGISTRY_SERVICE___FIND_BY_SCOPE_REGISTRY_AND_STAGE__STRING_STRING_STRING);
        createEOperation(eObjectRegistryServiceEClass,
                EOBJECT_REGISTRY_SERVICE___FIND_BY_SCOPE_REGISTRY_STAGE_AND_NAME__STRING_STRING_STRING_STRING);
    ...
    public void initializePackageContents() {
        ...
        ManagementPackage theManagementPackage = (ManagementPackage) EPackage.Registry.INSTANCE
                .getEPackage(ManagementPackage.eNS_URI);
        ...
        initEClass(eObjectGenerationServiceEClass, EObjectGenerationService.class, "EObjectGenerationService",
                IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        EOperation op = initEOperation(getEObjectGenerationService__RequestGeneration__String_String_String_String(),
                null, "requestGeneration", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectGenerationService__RequestGeneration__String_String_String_String_EObject(), null,
                "requestGeneration", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "jsonSample", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "sourceChannel", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "requestingUser", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "targetType", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectGenerationService__GetGenerationStatus__String(), null, "getGenerationStatus", 0,
        ...
        op = initEOperation(getEObjectGenerationService__CancelGeneration__String(), null, "cancelGeneration", 0, 1,
        ...
        op = initEOperation(getEObjectGenerationService__ListActiveGenerations(), null, "listActiveGenerations", 0, 1,
                IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getPromise());
        ...
        initEClass(eObjectDiscoveryServiceEClass, EObjectDiscoveryService.class, "EObjectDiscoveryService", IS_ABSTRACT,
                IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        op = initEOperation(getEObjectDiscoveryService__FindObjectByJsonPattern__String_String_String(), null,
                "findObjectByJsonPattern", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "jsonSample", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "sourceChannel", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "targetType", 1, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getPromise());
        ...
        op = initEOperation(getEObjectDiscoveryService__SearchSimilarObjects__String_String_double(), null,
                "searchSimilarObjects", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "jsonSample", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "targetType", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectDiscoveryService__CreateJsonFingerprint__String(), null, "createJsonFingerprint",
        ...
        op = initEOperation(getEObjectDiscoveryService__IsGenerationInProgress__String(), null,
                "isGenerationInProgress", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectDiscoveryService__CacheGenerationRequest__String_String(), null,
                "cacheGenerationRequest", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "jsonFingerprint", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "requestId", 1, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getPromise());
        ...
        op = initEOperation(getEObjectDiscoveryService__RemoveGenerationRequestFromCache__String(), null,
                "removeGenerationRequestFromCache", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "jsonFingerprint", 1, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getPromise());
        g2 = createEGenericType(theManagementPackage.getVoid());
        g1.getETypeArguments().add(g2);
        ...
        op = initEOperation(getEObjectDiscoveryService__CacheObjectMetadata__ObjectMetadata(), null,
                "cacheObjectMetadata", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectDiscoveryService__RemoveObjectRegistrationFromCache__String(), null,
                "removeObjectRegistrationFromCache", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectDiscoveryService__GetGenerationRequestIdForFingerprint__String(), null,
                "getGenerationRequestIdForFingerprint", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "jsonFingerprint", 1, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getPromise());
        g2 = createEGenericType(ecorePackage.getEString());
        g1.getETypeArguments().add(g2);
        ...
        initEClass(eObjectStorageServiceEClass, EObjectStorageService.class, "EObjectStorageService", IS_ABSTRACT,
                IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        op = initEOperation(getEObjectStorageService__StoreObject__String_String_String_String_EObject_ObjectMetadata(),
                null, "storeObject", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectStorageService__UpdateObject__String_EObject_ObjectMetadata(), null,
                "updateObject", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(eObjectStorageServiceEClass_T);
        addEParameter(op, g1, "object", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, theManagementPackage.getObjectMetadata(), "metadata", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectStorageService__RetrieveObject__String_String_String_String(), null,
                "retrieveObject", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectStorageService__RetrieveMetadata__String_String_String_String(), null,
                "retrieveMetadata", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectStorageService__DeleteObject__String_String_String_String(), null, "deleteObject",
                0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectStorageService__ListObjectIds__String_String_String(), null, "listObjectIds", 0,
                1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectStorageService__QueryObjects__ObjectQuery(), null, "queryObjects", 0, 1,
                IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectStorageService__UpdateMetadata__String_String_String_String_ObjectMetadata(),
                null, "updateMetadata", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectStorageService__UpdateStatus__String_String_String_String_ObjectStatus_String(),
                null, "updateStatus", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectStorageService__Exists__String_String_String_String(),
                ecorePackage.getEBooleanObject(), "exists", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);

        initEOperation(getEObjectStorageService__GetObjectCount(), ecorePackage.getELong(), "getObjectCount", 1, 1,
                IS_UNIQUE, IS_ORDERED);

        initEOperation(getEObjectStorageService__GetBackendType(), theManagementPackage.getStorageBackendType(),
                "getBackendType", 1, 1, IS_UNIQUE, IS_ORDERED);

        initEOperation(getEObjectStorageService__GetStorageType(), ecorePackage.getEString(), "getStorageType", 1, 1,
                IS_UNIQUE, IS_ORDERED);

        initEClass(eObjectRegistryServiceEClass, EObjectRegistryService.class, "EObjectRegistryService", IS_ABSTRACT,
                IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        op = initEOperation(getEObjectRegistryService__GetMetadata__String(), null, "getMetadata", 1, 1, IS_UNIQUE,
                IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectRegistryService__FindByObjectName__String(), null, "findByObjectName", 0, 1,
                IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectRegistryService__FindByObjectNameAndStage__String_String(), null,
                "findByObjectNameAndStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectName", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 1, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getOptional());
        g2 = createEGenericType(theManagementPackage.getObjectMetadata());
        ...
        op = initEOperation(getEObjectRegistryService__FindByStatus__ObjectStatus(), null, "findByStatus", 0, 1,
                IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectRegistryService__FindPendingApproval(), null, "findPendingApproval", 0, 1,
                IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getList());
        g2 = createEGenericType(theManagementPackage.getObjectMetadata());
        g1.getETypeArguments().add(g2);
        ...
        op = initEOperation(getEObjectRegistryService__FindByVersion__String(), null, "findByVersion", 0, 1, IS_UNIQUE,
                IS_ORDERED);
        ...
        op = initEOperation(getEObjectRegistryService__FindByVersionPattern__String(), null, "findByVersionPattern", 0,
                1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectRegistryService__FindByFingerprint__String(), null, "findByFingerprint", 0, 1,
                IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectRegistryService__FindByObjectType__String(), null, "findByObjectType", 0, 1,
                IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectRegistryService__FindByStatusAndType__ObjectStatus_String(), null,
                "findByStatusAndType", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, theManagementPackage.getObjectStatus(), "status", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectType", 1, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getList());
        g2 = createEGenericType(theManagementPackage.getObjectMetadata());
        ...
        op = initEOperation(getEObjectRegistryService__FindRecentlyModified__Instant_int(), null,
                "findRecentlyModified", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectRegistryService__UpdateCache__ObjectMetadata(), null, "updateCache", 0, 1,
                IS_UNIQUE, IS_ORDERED);
        addEParameter(op, theManagementPackage.getObjectMetadata(), "metadata", 1, 1, IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getEObjectRegistryService__RemoveFromCache__String(), null, "removeFromCache", 0, 1,
                IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "objectId", 1, 1, IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getEObjectRegistryService__GetRegistryStatistics(), null, "getRegistryStatistics", 0, 1,
                IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getPromise());
        ...
        op = initEOperation(getEObjectRegistryService__FindByScopeAndStage__String_String(), null,
                "findByScopeAndStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 1, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getList());
        g2 = createEGenericType(theManagementPackage.getObjectMetadata());
        ...
        op = initEOperation(getEObjectRegistryService__FindByScopeStageAndName__String_String_String(), null,
                "findByScopeStageAndName", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op = initEOperation(getEObjectRegistryService__FindByScopeRegistryAndStage__String_String_String(), null,
                "findByScopeRegistryAndStage", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 1, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(theManagementPackage.getList());
        ...
        op = initEOperation(getEObjectRegistryService__FindByScopeRegistryStageAndName__String_String_String_String(),
                null, "findByScopeRegistryStageAndName", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "scope", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "registry", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "stage", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEString(), "name", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        initEClass(storageRegistryEClass, StorageRegistry.class, "StorageRegistry", IS_ABSTRACT, IS_INTERFACE,
        ...
        op = initEOperation(getStorageRegistry__SearchMetadataAcrossTypes__ObjectQuery(),
                theManagementPackage.getObjectMetadata(), "searchMetadataAcrossTypes", 0, -1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, theManagementPackage.getObjectQuery(), "query", 1, 1, IS_UNIQUE, IS_ORDERED);

        op = initEOperation(getStorageRegistry__GetStorageStatistics(), null, "getStorageStatistics", 0, 1, IS_UNIQUE,
                IS_ORDERED);
        ...
        op = initEOperation(getStorageRegistry__GetStorageByType__String(), null, "getStorageByType", 0, 1, IS_UNIQUE,
                IS_ORDERED);
        ...
        initEOperation(getStorageRegistry__GetAvailableTypes(), ecorePackage.getEString(), "getAvailableTypes", 0, -1,
                IS_UNIQUE, IS_ORDERED);
