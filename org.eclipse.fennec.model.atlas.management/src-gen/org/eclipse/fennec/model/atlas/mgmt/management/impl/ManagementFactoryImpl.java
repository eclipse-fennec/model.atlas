...
public class ManagementFactoryImpl extends EFactoryImpl implements ManagementFactory {
    ...
    public static ManagementFactory init() {
        try {
            ManagementFactory theManagementFactory = (ManagementFactory) EPackage.Registry.INSTANCE
                    .getEFactory(ManagementPackage.eNS_URI);
    ...
    public EObject create(EClass eClass) {
        ...
        case ManagementPackage.OBJECT_METADATA_CONTAINER:
            return createObjectMetadataContainer();
        default:
