...
public class ManagementAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected ManagementSwitch<Adapter> modelSwitch = new ManagementSwitch<Adapter>() {
        @Override
     ...
     * <em>Object Metadata</em>}'. <!-- begin-user-doc --> This default
     ...
     * <em>String To Object Map Entry</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's useful
     * to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
     * 
     ...
     * Query</em>}'. <!-- begin-user-doc --> This default implementation returns
     ...
     * <em>Generation Request</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's useful
     * to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
     * 
     ...
     * <em>Object Metadata Container</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's useful
     * to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
     * 
