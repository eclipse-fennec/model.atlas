...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.model.atlas.mgmt.management\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.osgi.service.condition.Condition\"" , "uses:=org.osgi.service.condition" })
public class ManagementConfigurationComponent {

	private static final System.Logger LOG = System.getLogger(ManagementConfigurationComponent.class.getName());
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(ManagementPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(ManagementPackage.eNS_URI, ePackage);
		}
