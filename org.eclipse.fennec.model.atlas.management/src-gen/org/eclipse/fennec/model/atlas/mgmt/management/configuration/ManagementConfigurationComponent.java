...
@Capability(namespace = "osgi.service", attribute = {
        "objectClass:List<String>=\"org.eclipse.fennec.model.atlas.mgmt.management.util.ManagementResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"",
        "uses:=\"org.eclipse.emf.ecore.resource,org.eclipse.fennec.model.atlas.mgmt.management.util\"" })
@Capability(namespace = "osgi.service", attribute = {
        "objectClass:List<String>=\"org.eclipse.fennec.model.atlas.mgmt.management.ManagementFactory, org.eclipse.emf.ecore.EFactory\"",
        "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.model.atlas.mgmt.management\"" })
@Capability(namespace = "osgi.service", attribute = {
        "objectClass:List<String>=\"org.eclipse.fennec.model.atlas.mgmt.management.ManagementPackage, org.eclipse.emf.ecore.EPackage\"",
        "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.model.atlas.mgmt.management\"" })
@Capability(namespace = "osgi.service", attribute = {
...
public class ManagementConfigurationComponent {
     ...
     * @generated
     */
    private ManagementEPackageConfigurator registerEPackageConfiguratorService(ManagementPackage ePackage,
            BundleContext ctx) {
    ...
    private void registerResourceFactoryService(BundleContext ctx) {
        ...
        String[] serviceClasses = new String[] { ManagementResourceFactoryImpl.class.getName(),
     ...
     * @generated
     */
    private void registerEPackageService(ManagementPackage ePackage, ManagementEPackageConfigurator packageConfigurator,
            BundleContext ctx) {
        Hashtable<String, Object> properties = new Hashtable<String, Object>();
        properties.putAll(packageConfigurator.getServiceProperties());
     ...
     * @generated
     */
    private void registerEFactoryService(ManagementPackage ePackage, ManagementEPackageConfigurator packageConfigurator,
            BundleContext ctx) {
        Hashtable<String, Object> properties = new Hashtable<String, Object>();
        properties.putAll(packageConfigurator.getServiceProperties());
