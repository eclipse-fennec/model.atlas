 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * How serious a finding is, in the order of org.eclipse.emf.common.util.Diagnostic.
 * There is no OK literal: a diagnostic exists because something was found; an object
 * without findings has no diagnostics.
 * <!-- end-model-doc -->
 * @see org.eclipse.fennec.model.atlas.mgmt.management.ManagementPackage#getDiagnosticSeverity()
 * @model
 * @generated
 */
@ProviderType
public enum DiagnosticSeverity implements Enumerator {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Something to look at; the object remains usable
	 * <!-- end-model-doc -->
	 * @see #WARNING_VALUE
	 * @generated
	 * @ordered
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * The object does not hold up as it stands; a gate may refuse an operation on it
	 * <!-- end-model-doc -->
	 * @see #ERROR_VALUE
	 * @generated
	 * @ordered
