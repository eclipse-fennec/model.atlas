 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.GenerationRequestImpl#getRequestId
 * <em>Request Id</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.GenerationRequestImpl#getJsonSample
 * <em>Json Sample</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.GenerationRequestImpl#getJsonFingerprint
 * <em>Json Fingerprint</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.GenerationRequestImpl#getSourceChannel
 * <em>Source Channel</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.GenerationRequestImpl#getRequestingUser
 * <em>Requesting User</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.GenerationRequestImpl#getStatus
 * <em>Status</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.GenerationRequestImpl#getRequestTime
 * <em>Request Time</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.GenerationRequestImpl#getStartTime
 * <em>Start Time</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.GenerationRequestImpl#getCompletionTime
 * <em>Completion Time</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.GenerationRequestImpl#getErrorMessage
 * <em>Error Message</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.GenerationRequestImpl#getResultPackageId
...
public class GenerationRequestImpl extends MinimalEObjectImpl.Container implements GenerationRequest {
    /**
     * The default value of the '{@link #getRequestId() <em>Request Id</em>}'
    ...
    /**
     * The cached value of the '{@link #getRequestId() <em>Request Id</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getRequestId()
     * @generated
    ...
    /**
     * The default value of the '{@link #getJsonSample() <em>Json Sample</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getJsonSample()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getJsonSample() <em>Json Sample</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getJsonSample()
     * @generated
    ...
    /**
     * The default value of the '{@link #getJsonFingerprint() <em>Json
     * Fingerprint</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getJsonFingerprint() <em>Json
     * Fingerprint</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getJsonFingerprint()
     * @generated
    ...
    /**
     * The default value of the '{@link #getRequestingUser() <em>Requesting
    ...
    /**
     * The cached value of the '{@link #getRequestingUser() <em>Requesting
     * User</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getRequestingUser()
     * @generated
    ...
    /**
     * The default value of the '{@link #getRequestTime() <em>Request Time</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getRequestTime()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getRequestTime() <em>Request Time</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getRequestTime()
     * @generated
    ...
    /**
     * The default value of the '{@link #getCompletionTime() <em>Completion
    ...
    /**
     * The cached value of the '{@link #getCompletionTime() <em>Completion
     * Time</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getCompletionTime()
     * @generated
    ...
    /**
     * The default value of the '{@link #getResultPackageId() <em>Result Package
    ...
    /**
     * The cached value of the '{@link #getResultPackageId() <em>Result Package
     * Id</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getResultPackageId()
     * @generated
    ...
    public void setRequestId(String newRequestId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ManagementPackage.GENERATION_REQUEST__REQUEST_ID,
    ...
    public void setJsonSample(String newJsonSample) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ManagementPackage.GENERATION_REQUEST__JSON_SAMPLE,
                    oldJsonSample, jsonSample));
    }
    ...
    public void setJsonFingerprint(String newJsonFingerprint) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ManagementPackage.GENERATION_REQUEST__JSON_FINGERPRINT, oldJsonFingerprint, jsonFingerprint));
    }
    ...
    public void setSourceChannel(String newSourceChannel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ManagementPackage.GENERATION_REQUEST__SOURCE_CHANNEL,
    ...
    public void setRequestingUser(String newRequestingUser) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ManagementPackage.GENERATION_REQUEST__REQUESTING_USER,
                    oldRequestingUser, requestingUser));
    }
    ...
    public void setStatus(GenerationStatus newStatus) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ManagementPackage.GENERATION_REQUEST__STATUS,
                    oldStatus, status));
    }
    ...
    public void setRequestTime(Instant newRequestTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ManagementPackage.GENERATION_REQUEST__REQUEST_TIME,
                    oldRequestTime, requestTime));
    }
    ...
    public void setStartTime(Instant newStartTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ManagementPackage.GENERATION_REQUEST__START_TIME,
    ...
    public void setCompletionTime(Instant newCompletionTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ManagementPackage.GENERATION_REQUEST__COMPLETION_TIME,
    ...
    public void setErrorMessage(String newErrorMessage) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ManagementPackage.GENERATION_REQUEST__ERROR_MESSAGE,
    ...
    public void setResultPackageId(String newResultPackageId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ManagementPackage.GENERATION_REQUEST__RESULT_PACKAGE_ID, oldResultPackageId, resultPackageId));
    }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case ManagementPackage.GENERATION_REQUEST__JSON_FINGERPRINT:
            return JSON_FINGERPRINT_EDEFAULT == null ? jsonFingerprint != null
                    : !JSON_FINGERPRINT_EDEFAULT.equals(jsonFingerprint);
        case ManagementPackage.GENERATION_REQUEST__SOURCE_CHANNEL:
            return SOURCE_CHANNEL_EDEFAULT == null ? sourceChannel != null
                    : !SOURCE_CHANNEL_EDEFAULT.equals(sourceChannel);
        case ManagementPackage.GENERATION_REQUEST__REQUESTING_USER:
            return REQUESTING_USER_EDEFAULT == null ? requestingUser != null
                    : !REQUESTING_USER_EDEFAULT.equals(requestingUser);
        case ManagementPackage.GENERATION_REQUEST__STATUS:
        ...
        case ManagementPackage.GENERATION_REQUEST__COMPLETION_TIME:
            return COMPLETION_TIME_EDEFAULT == null ? completionTime != null
                    : !COMPLETION_TIME_EDEFAULT.equals(completionTime);
        case ManagementPackage.GENERATION_REQUEST__ERROR_MESSAGE:
            return ERROR_MESSAGE_EDEFAULT == null ? errorMessage != null : !ERROR_MESSAGE_EDEFAULT.equals(errorMessage);
        case ManagementPackage.GENERATION_REQUEST__RESULT_PACKAGE_ID:
            return RESULT_PACKAGE_ID_EDEFAULT == null ? resultPackageId != null
                    : !RESULT_PACKAGE_ID_EDEFAULT.equals(resultPackageId);
        }
