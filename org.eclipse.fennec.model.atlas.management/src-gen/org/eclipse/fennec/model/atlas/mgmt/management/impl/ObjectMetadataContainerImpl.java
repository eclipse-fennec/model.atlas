 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.ObjectMetadataContainerImpl#getContainerId
 * <em>Container Id</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.management.impl.ObjectMetadataContainerImpl#getMetadata
 * <em>Metadata</em>}</li>
 * </ul>
 *
 * @generated
...
public class ObjectMetadataContainerImpl extends MinimalEObjectImpl.Container implements ObjectMetadataContainer {
    /**
     * The default value of the '{@link #getContainerId() <em>Container Id</em>}'
    ...
    /**
     * The cached value of the '{@link #getContainerId() <em>Container Id</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getContainerId()
     * @generated
    ...
    public void setContainerId(String newContainerId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ManagementPackage.OBJECT_METADATA_CONTAINER__CONTAINER_ID, oldContainerId, containerId));
    }
    ...
    public EList<ObjectMetadata> getMetadata() {
        if (metadata == null) {
            metadata = new EObjectContainmentEList<ObjectMetadata>(ObjectMetadata.class, this,
                    ManagementPackage.OBJECT_METADATA_CONTAINER__METADATA);
        }
        return metadata;
    }
