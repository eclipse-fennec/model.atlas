...
public class ManagementPackageImpl extends EPackageImpl implements ManagementPackage {
     ...
     *
     * <p>
     * This method is used to initialize {@link ManagementPackage#eINSTANCE} when
    ...
    public static ManagementPackage init() {
        if (isInited)
            return (ManagementPackage) EPackage.Registry.INSTANCE.getEPackage(ManagementPackage.eNS_URI);

        // Obtain or create and register package
        Object registeredManagementPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
        ManagementPackageImpl theManagementPackage = registeredManagementPackage instanceof ManagementPackageImpl
                ? (ManagementPackageImpl) registeredManagementPackage
                : new ManagementPackageImpl();
    ...
    public void initializePackageContents() {
        ...
        initEClass(objectMetadataEClass, ObjectMetadata.class, "ObjectMetadata", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getObjectMetadata_UploadUser(), ecorePackage.getEString(), "uploadUser", null, 1, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_UploadTime(), this.getInstant(), "uploadTime", null, 1, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_SourceChannel(), ecorePackage.getEString(), "sourceChannel", null, 1, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_ContentHash(), ecorePackage.getEString(), "contentHash", null, 1, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_ObjectType(), ecorePackage.getEString(), "objectType", null, 1, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_ReviewUser(), ecorePackage.getEString(), "reviewUser", null, 0, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_ReviewTime(), this.getInstant(), "reviewTime", null, 0, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_ReviewReason(), ecorePackage.getEString(), "reviewReason", null, 0, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_GenerationTriggerFingerprint(), ecorePackage.getEString(),
                "generationTriggerFingerprint", null, 0, 1, ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_ComplianceCheckTime(), this.getInstant(), "complianceCheckTime", null, 0, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_ComplianceStatus(), ecorePackage.getEString(), "complianceStatus", null, 0, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_GovernanceDocumentationId(), ecorePackage.getEString(),
                "governanceDocumentationId", null, 0, 1, ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getObjectMetadata_Properties(), this.getStringToObjectMapEntry(), null, "properties", null, 0,
                -1, ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_LastChangeUser(), ecorePackage.getEString(), "lastChangeUser", null, 0, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_LastChangeTime(), this.getInstant(), "lastChangeTime", null, 0, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_Status(), this.getObjectStatus(), "status", "DRAFT", 1, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_Version(), ecorePackage.getEString(), "version", null, 0, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getObjectMetadata_ObjectRef(), ecorePackage.getEObject(), null, "objectRef", null, 0, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_ObjectId(), ecorePackage.getEString(), "objectId", null, 1, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_ObjectName(), ecorePackage.getEString(), "objectName", null, 0, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_Stage(), ecorePackage.getEString(), "stage", null, 1, 1, ObjectMetadata.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_LastChangeReason(), ecorePackage.getEString(), "lastChangeReason", null, 0, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_Scope(), ecorePackage.getEString(), "scope", null, 1, 1, ObjectMetadata.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_IsReadOnly(), ecorePackage.getEBoolean(), "isReadOnly", null, 0, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectMetadata_Registry(), ecorePackage.getEString(), "registry", null, 1, 1,
                ObjectMetadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getStringToObjectMapEntry_Key(), ecorePackage.getEString(), "key", null, 1, 1, Map.Entry.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStringToObjectMapEntry_Value(), ecorePackage.getEJavaObject(), "value", null, 1, 1,
                Map.Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(objectQueryEClass, ObjectQuery.class, "ObjectQuery", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getObjectQuery_UploadUser(), ecorePackage.getEString(), "uploadUser", null, 0, 1,
                ObjectQuery.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectQuery_SourceChannel(), ecorePackage.getEString(), "sourceChannel", null, 0, 1,
                ObjectQuery.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectQuery_ObjectType(), ecorePackage.getEString(), "objectType", null, 0, 1,
                ObjectQuery.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectQuery_Status(), this.getObjectStatus(), "status", null, 0, 1, ObjectQuery.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectQuery_Stage(), ecorePackage.getEString(), "stage", null, 0, 1, ObjectQuery.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectQuery_Scope(), ecorePackage.getEString(), "scope", null, 0, 1, ObjectQuery.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectQuery_Name(), ecorePackage.getEString(), "name", null, 0, 1, ObjectQuery.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getObjectQuery_Registry(), ecorePackage.getEString(), "registry", null, 0, 1, ObjectQuery.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(generationRequestEClass, GenerationRequest.class, "GenerationRequest", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getGenerationRequest_RequestId(), ecorePackage.getEString(), "requestId", null, 1, 1,
                GenerationRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGenerationRequest_JsonSample(), ecorePackage.getEString(), "jsonSample", null, 1, 1,
                GenerationRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGenerationRequest_JsonFingerprint(), ecorePackage.getEString(), "jsonFingerprint", null, 1, 1,
                GenerationRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGenerationRequest_SourceChannel(), ecorePackage.getEString(), "sourceChannel", null, 1, 1,
                GenerationRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGenerationRequest_RequestingUser(), ecorePackage.getEString(), "requestingUser", null, 1, 1,
                GenerationRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGenerationRequest_Status(), this.getGenerationStatus(), "status", "REQUESTED", 1, 1,
                GenerationRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGenerationRequest_RequestTime(), this.getInstant(), "requestTime", null, 1, 1,
                GenerationRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGenerationRequest_StartTime(), this.getInstant(), "startTime", null, 0, 1,
                GenerationRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGenerationRequest_CompletionTime(), this.getInstant(), "completionTime", null, 0, 1,
                GenerationRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGenerationRequest_ErrorMessage(), ecorePackage.getEString(), "errorMessage", null, 0, 1,
                GenerationRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGenerationRequest_ResultPackageId(), ecorePackage.getEString(), "resultPackageId", null, 0, 1,
                GenerationRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(objectMetadataContainerEClass, ObjectMetadataContainer.class, "ObjectMetadataContainer",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getObjectMetadataContainer_ContainerId(), ecorePackage.getEString(), "containerId", null, 1, 1,
                ObjectMetadataContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getObjectMetadataContainer_Metadata(), this.getObjectMetadata(), null, "metadata", null, 0, -1,
                ObjectMetadataContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
    ...
    protected void createGenModelAnnotations() {
        ...
        addAnnotation(this, source, new String[] { "modelName", "Management", "complianceLevel", "17.0",
                "copyrightText",
                "Copyright (c) 2012 - 2025 Data In Motion and others.\nAll rights reserved.\n\nThis program and the accompanying materials are made\navailable under the terms of the Eclipse Public License 2.0\nwhich is available at https://www.eclipse.org/legal/epl-2.0/\n\nSPDX-License-Identifier: EPL-2.0\n\nContributors:\n     Data In Motion - initial API and implementation",
                "resource", "XMI", "oSGiCompatible", "true", "prefix", "Management", "basePackage",
                "org.eclipse.fennec.model.atlas.mgmt" });
        addAnnotation(objectMetadataEClass, source,
                new String[] { "documentation", "Generic metadata associated with uploaded EObject" });
        addAnnotation(getObjectMetadata_UploadUser(), source,
                new String[] { "documentation", "User who uploaded the object" });
        addAnnotation(getObjectMetadata_UploadTime(), source,
                new String[] { "documentation", "Timestamp when object was uploaded" });
        addAnnotation(getObjectMetadata_SourceChannel(), source,
                new String[] { "documentation", "Source channel (e.g., AI_GENERATOR, MANUAL_UPLOAD, SENSINACT)" });
        addAnnotation(getObjectMetadata_ContentHash(), source,
                new String[] { "documentation", "SHA-256 hash of XMI content" });
        addAnnotation(getObjectMetadata_ObjectType(), source,
                new String[] { "documentation", "Type of the EObject (e.g., EPackage, Route, SensorModel)" });
        addAnnotation(getObjectMetadata_ReviewUser(), source,
                new String[] { "documentation", "User who reviewed the object (for approve/reject)" });
        addAnnotation(getObjectMetadata_ReviewTime(), source,
                new String[] { "documentation", "Timestamp when object was reviewed" });
        addAnnotation(getObjectMetadata_ReviewReason(), source,
                new String[] { "documentation", "Reason for approval or rejection" });
        addAnnotation(getObjectMetadata_GenerationTriggerFingerprint(), source, new String[] { "documentation",
                "This is the fingerprint of the json which triggered the generation of this Object" });
        addAnnotation(getObjectMetadata_ComplianceCheckTime(), source,
                new String[] { "documentation", "Timestamp when compliance checks were last performed" });
        addAnnotation(getObjectMetadata_ComplianceStatus(), source, new String[] { "documentation",
                "Overall compliance check result (uses governance.ComplianceStatus values as strings)" });
        addAnnotation(getObjectMetadata_GovernanceDocumentationId(), source, new String[] { "documentation",
                "Reference to the governance documentation containing detailed compliance results" });
        addAnnotation(getObjectMetadata_Properties(), source,
                new String[] { "documentation", "Additional metadata properties" });
        addAnnotation(getObjectMetadata_LastChangeUser(), source, new String[] { "documentation",
                "User who last modified the object (only set when object is updated after initial upload)" });
        addAnnotation(getObjectMetadata_LastChangeTime(), source, new String[] { "documentation",
                "Timestamp when object was last modified (only set when object is updated after initial upload)" });
        addAnnotation(getObjectMetadata_Status(), source, new String[] { "documentation", "Object lifecycle status" });
        addAnnotation(getObjectMetadata_Version(), source,
                new String[] { "documentation", "Object version for optimistic locking" });
        addAnnotation(getObjectMetadata_ObjectRef(), source,
                new String[] { "documentation", "Reference to the actual managed EObject" });
        addAnnotation(getObjectMetadata_ObjectId(), source, new String[] { "documentation",
                "Unique metadata identifier (distinct from storage objectId key) for cross-referencing and registry lookups" });
        addAnnotation(getObjectMetadata_ObjectName(), source,
                new String[] { "documentation", "Human-readable object name" });
        addAnnotation(getObjectMetadata_Stage(), source, new String[] { "documentation",
                "The stage to which this metadata belongs (e.g. draft, approved, released, etc.)" });
        addAnnotation(getObjectMetadata_LastChangeReason(), source,
                new String[] { "documentation", "Reason for approval or rejection" });
        addAnnotation(getObjectMetadata_Scope(), source, new String[] { "documentation",
                "The scope to which this metadata belongs (it\'s the tenant that own the object)" });
        addAnnotation(getObjectMetadata_IsReadOnly(), source, new String[] { "documentation",
                "This is to be set when an EObject is retrieved from a parent scope in its final stage and then cannot be modified." });
        addAnnotation(getObjectMetadata_Registry(), source, new String[] { "documentation",
                "The registry to which this metadata belongs (e.g. schema, configuration, script, etc.)" });
        addAnnotation(stringToObjectMapEntryEClass, source,
                new String[] { "documentation", "String Key - Object value map entry" });
        addAnnotation(getStringToObjectMapEntry_Key(), source, new String[] { "documentation", "Property key" });
        addAnnotation(getStringToObjectMapEntry_Value(), source, new String[] { "documentation", "Property value" });
        addAnnotation(objectQueryEClass, source,
                new String[] { "documentation", "Generic query criteria for searching objects" });
        addAnnotation(getObjectQuery_UploadUser(), source, new String[] { "documentation", "Filter by upload user" });
        addAnnotation(getObjectQuery_SourceChannel(), source,
                new String[] { "documentation", "Filter by source channel" });
        addAnnotation(getObjectQuery_ObjectType(), source, new String[] { "documentation", "Filter by object type" });
        addAnnotation(getObjectQuery_Status(), source, new String[] { "documentation", "Filter by object status" });
        addAnnotation(getObjectQuery_Stage(), source, new String[] { "documentation", "Filter by object role" });
        addAnnotation(getObjectQuery_Scope(), source, new String[] { "documentation", "Filter by object scope" });
        addAnnotation(getObjectQuery_Name(), source, new String[] { "documentation", "Filter by object name" });
        addAnnotation(getObjectQuery_Registry(), source, new String[] { "documentation", "Filter by object scope" });
        addAnnotation(generationRequestEClass, source,
                new String[] { "documentation", "Request for AI-based EPackage generation" });
        addAnnotation(getGenerationRequest_RequestId(), source,
                new String[] { "documentation", "Unique request identifier" });
        addAnnotation(getGenerationRequest_JsonSample(), source,
                new String[] { "documentation", "JSON sample used for generation" });
        addAnnotation(getGenerationRequest_JsonFingerprint(), source,
                new String[] { "documentation", "Structural fingerprint of JSON sample" });
        addAnnotation(getGenerationRequest_SourceChannel(), source,
                new String[] { "documentation", "Source channel that triggered generation" });
        addAnnotation(getGenerationRequest_RequestingUser(), source,
                new String[] { "documentation", "User who requested generation" });
        addAnnotation(getGenerationRequest_Status(), source,
                new String[] { "documentation", "Current generation status" });
        addAnnotation(getGenerationRequest_RequestTime(), source,
                new String[] { "documentation", "When generation was requested" });
        addAnnotation(getGenerationRequest_StartTime(), source,
                new String[] { "documentation", "When generation started" });
        addAnnotation(getGenerationRequest_CompletionTime(), source,
                new String[] { "documentation", "When generation completed" });
        addAnnotation(getGenerationRequest_ErrorMessage(), source,
                new String[] { "documentation", "Error message if generation failed" });
        addAnnotation(getGenerationRequest_ResultPackageId(), source,
                new String[] { "documentation", "Package ID of generated EPackage" });
        addAnnotation(objectStatusEEnum, source, new String[] { "documentation", "Generic object lifecycle status" });
        addAnnotation(objectStatusEEnum.getELiterals().get(0), source,
                new String[] { "documentation", "Object is in draft state" });
        addAnnotation(objectStatusEEnum.getELiterals().get(1), source,
                new String[] { "documentation", "Object has been approved for release" });
        addAnnotation(objectStatusEEnum.getELiterals().get(2), source,
                new String[] { "documentation", "Object has been rejected during review" });
        addAnnotation(objectStatusEEnum.getELiterals().get(3), source,
                new String[] { "documentation", "Object has been deployed to production" });
        addAnnotation(objectStatusEEnum.getELiterals().get(4), source,
                new String[] { "documentation", "Object has been archived" });
        addAnnotation(packageStatusEEnum, source, new String[] { "documentation", "Package lifecycle status" });
        addAnnotation(packageStatusEEnum.getELiterals().get(0), source,
                new String[] { "documentation", "Package is in draft state" });
        addAnnotation(packageStatusEEnum.getELiterals().get(1), source,
                new String[] { "documentation", "Package has been approved" });
        addAnnotation(packageStatusEEnum.getELiterals().get(2), source,
                new String[] { "documentation", "Package has been deployed" });
        addAnnotation(packageStatusEEnum.getELiterals().get(3), source,
                new String[] { "documentation", "Package has been archived" });
        addAnnotation(storageBackendTypeEEnum, source, new String[] { "documentation", "Storage backend types" });
        addAnnotation(storageBackendTypeEEnum.getELiterals().get(0), source,
                new String[] { "documentation", "File object storage backend" });
        addAnnotation(storageBackendTypeEEnum.getELiterals().get(1), source,
                new String[] { "documentation", "MinIO object storage backend" });
        addAnnotation(storageBackendTypeEEnum.getELiterals().get(2), source,
                new String[] { "documentation", "Git-based storage backend" });
        addAnnotation(storageBackendTypeEEnum.getELiterals().get(3), source,
                new String[] { "documentation", "Apicurio-based storage backend" });
        addAnnotation(generationStatusEEnum, source,
                new String[] { "documentation", "Status of EPackage generation request" });
        addAnnotation(generationStatusEEnum.getELiterals().get(0), source,
                new String[] { "documentation", "Generation has been requested" });
        addAnnotation(generationStatusEEnum.getELiterals().get(1), source,
                new String[] { "documentation", "AI is actively generating the model" });
        addAnnotation(generationStatusEEnum.getELiterals().get(2), source,
                new String[] { "documentation", "Generation completed successfully" });
        addAnnotation(generationStatusEEnum.getELiterals().get(3), source,
                new String[] { "documentation", "Generation failed with error" });
        addAnnotation(generationStatusEEnum.getELiterals().get(4), source,
                new String[] { "documentation", "Generation was cancelled" });
        addAnnotation(instantEDataType, source,
                new String[] { "documentation", "Java 8 Instant for precise timestamps" });
        addAnnotation(objectMetadataContainerEClass, source, new String[] { "documentation",
        ...
        addAnnotation(getObjectMetadataContainer_ContainerId(), source,
                new String[] { "documentation", "Unique container identifier" });
        addAnnotation(getObjectMetadataContainer_Metadata(), source, new String[] { "documentation",
                "Collection of metadata objects with automatic keying by objectId for efficient lookups" });
    }

    /**
     * Initializes the annotations for <b>java.time.Instant</b>. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected void createJavaAnnotations() {
        ...
        addAnnotation(instantEDataType, source, new String[] {});
    }
