 ...
 * 
 * <p>
 * This class provides the common interface for different registry
 * implementations that can index and search ObjectMetadata. Implementations can
 * use in-memory caches, Lucene indexes, or other storage mechanisms for fast
 * metadata lookups.
 * </p>
 * 
 * <h3>Separation of Concerns</h3>
 * <p>
 * Registry helpers are separate from storage helpers:
 * </p>
 * <ul>
 * <li><strong>RegistryHelper</strong> - Handles metadata indexing and search
 * operations</li>
 * <li><strong>StorageHelper</strong> - Handles actual object persistence
 * (files, cloud, etc.)</li>
 * </ul>
 * 
 * <h3>Package Organization</h3>
 * <ul>
 * <li><strong>org.gecko.mac.mgmt.registry</strong> - Abstract registry
 * interfaces and base classes</li>
 * <li><strong>org.gecko.mac.management.file.registry</strong> - File-based
 * registry implementations (Lucene)</li>
 * <li><strong>org.gecko.mac.mgmt.storage</strong> - Storage helper interfaces
 * and base classes</li>
 * <li><strong>org.gecko.mac.management.file</strong> - File-based storage
 * implementations</li>
 * </ul>
 * 
 * <h3>Implementations</h3>
 * <ul>
 * <li><strong>LuceneRegistryHelper</strong> - Fast Lucene-based indexing with
 * complex queries</li>
 * <li><strong>BasicRegistryHelper</strong> - Simple in-memory indexing for
 * smaller datasets</li>
 * </ul>
 * 
...
public abstract class AbstractRegistryHelper implements AutoCloseable {
    ...
    /**
     * Initialize the registry helper. Called during service activation.
     * 
    ...
    /**
     * Rebuild the entire index from scratch. This operation can be expensive and
