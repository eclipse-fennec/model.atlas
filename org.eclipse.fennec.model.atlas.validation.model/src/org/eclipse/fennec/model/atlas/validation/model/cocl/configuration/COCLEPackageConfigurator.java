 ...
 * @generated
 */
public class COCLEPackageConfigurator implements EPackageConfigurator {
	
	private COCLPackage ePackage;

	protected COCLEPackageConfigurator(COCLPackage ePackage){
	...
	public void configureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.put(COCLPackage.eNS_URI, ePackage);
	}
	...
	public void unconfigureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.remove(COCLPackage.eNS_URI);
	}
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_NAME, COCLPackage.eNAME);
		properties.put(EMFNamespaces.EMF_MODEL_NSURI, COCLPackage.eNS_URI);
		properties.put(EMFNamespaces.EMF_MODEL_REGISTRATION, EMFNamespaces.MODEL_REGISTRATION_PROVIDED);
		properties.put(EMFNamespaces.EMF_MODEL_FILE_EXT, "cocl");
