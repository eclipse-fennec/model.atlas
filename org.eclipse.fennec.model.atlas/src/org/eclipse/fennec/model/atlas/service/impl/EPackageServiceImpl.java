...
public class EPackageServiceImpl implements EPackageService {
    ...
    public void deactivate() {
        ...
        try {
            ...
            serviceRegistrations.values()
                    .forEach(registrations -> registrations.forEach(ServiceRegistration::unregister));
    ...
    public Optional<EPackage> registerEPackage(EPackage ePackage) {
        ...
        try {
            ...
            ServiceRegistration<EPackageConfigurator> configuratorReg = bundleContext
                    .registerService(EPackageConfigurator.class, configurator, createServiceProperties(ePackage));
            registrations.add(configuratorReg);

            // Register EPackage itself as service
            ServiceRegistration<EPackage> packageReg = bundleContext.registerService(EPackage.class, ePackage,
    ...
    public List<EPackage> listEPackages() {
        return resourceSet.getPackageRegistry().values().stream().filter(EPackage.class::isInstance)
                .map(EPackage.class::cast).toList();
    }
