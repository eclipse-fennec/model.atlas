...
public interface EPackageService {
     ...
     * @return Optional containing the registered package, or empty if nsUri already
     *         exists
     * @throws IllegalArgumentException if EPackage is invalid (null or missing
     *                                  nsUri)
     */
     ...
     * @return true if the EPackage was registered and removed, false if it didn't
     *         exist
     */
