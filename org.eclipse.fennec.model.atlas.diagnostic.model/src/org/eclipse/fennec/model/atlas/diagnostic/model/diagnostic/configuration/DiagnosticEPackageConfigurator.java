 ...
 * @generated
 */
public class DiagnosticEPackageConfigurator implements EPackageConfigurator {
	
	private DiagnosticPackage ePackage;

	protected DiagnosticEPackageConfigurator(DiagnosticPackage ePackage){
	...
	public void configureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.put(DiagnosticPackage.eNS_URI, ePackage);
	}
	...
	public void unconfigureEPackage(org.eclipse.emf.ecore.EPackage.Registry registry) {
		registry.remove(DiagnosticPackage.eNS_URI);
	}
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_NAME, DiagnosticPackage.eNAME);
		properties.put(EMFNamespaces.EMF_MODEL_NSURI, DiagnosticPackage.eNS_URI);
