...
> For details on the indexing design and search field semantics, see the EPackage Lucene Indexing design document (`docs/design/epackage-lucene-indexing_v2.md`) in the central docs repository (`DataInMotion/xdp`, under `docs/projects/model.atlas/`).
