 ...
 * '<em><b>EPackage List Response</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fennec.model.atlas.rest.model.impl.EPackageListResponseImpl#getPackages
 * <em>Packages</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.rest.model.impl.EPackageListResponseImpl#getTotal
 * <em>Total</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.rest.model.impl.EPackageListResponseImpl#getSkip
 * <em>Skip</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.rest.model.impl.EPackageListResponseImpl#getLimit
 * <em>Limit</em>}</li>
 * </ul>
 *
 * @generated
...
public class EPackageListResponseImpl extends MinimalEObjectImpl.Container implements EPackageListResponse {
    ...
    public EList<EPackageInfo> getPackages() {
        if (packages == null) {
            packages = new EObjectContainmentEList<EPackageInfo>(EPackageInfo.class, this,
                    RestPackage.EPACKAGE_LIST_RESPONSE__PACKAGES);
        }
        return packages;
    }
    ...
    public void setTotal(int newTotal) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestPackage.EPACKAGE_LIST_RESPONSE__TOTAL, oldTotal,
                    total));
    }
    ...
    public void setSkip(int newSkip) {
        ...
        skip = newSkip;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestPackage.EPACKAGE_LIST_RESPONSE__SKIP, oldSkip,
                    skip));
    }
    ...
    public void setLimit(int newLimit) {
        ...
        limit = newLimit;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestPackage.EPACKAGE_LIST_RESPONSE__LIMIT, oldLimit,
                    limit));
    }
