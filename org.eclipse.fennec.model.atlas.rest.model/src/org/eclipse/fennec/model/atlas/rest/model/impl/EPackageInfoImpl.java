 ...
 * '<em><b>EPackage Info</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fennec.model.atlas.rest.model.impl.EPackageInfoImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.rest.model.impl.EPackageInfoImpl#getNsURI
 * <em>Ns URI</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.rest.model.impl.EPackageInfoImpl#getNsPrefix
 * <em>Ns Prefix</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.rest.model.impl.EPackageInfoImpl#getClassifierCount
 * <em>Classifier Count</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.rest.model.impl.EPackageInfoImpl#getSubPackageCount
 * <em>Sub Package Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EPackageInfoImpl extends MinimalEObjectImpl.Container implements EPackageInfo {
    ...
    /**
     * The default value of the '{@link #getClassifierCount() <em>Classifier
    ...
    /**
     * The cached value of the '{@link #getClassifierCount() <em>Classifier
     * Count</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getClassifierCount()
     * @generated
    ...
    /**
     * The default value of the '{@link #getSubPackageCount() <em>Sub Package
     * Count</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getSubPackageCount() <em>Sub Package
     * Count</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getSubPackageCount()
     * @generated
    ...
    public void setNsPrefix(String newNsPrefix) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestPackage.EPACKAGE_INFO__NS_PREFIX, oldNsPrefix,
                    nsPrefix));
    }
    ...
    public void setClassifierCount(int newClassifierCount) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestPackage.EPACKAGE_INFO__CLASSIFIER_COUNT,
                    oldClassifierCount, classifierCount));
    }
    ...
    public void setSubPackageCount(int newSubPackageCount) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestPackage.EPACKAGE_INFO__SUB_PACKAGE_COUNT,
                    oldSubPackageCount, subPackageCount));
    }
