...
public class RestPackageImpl extends EPackageImpl implements RestPackage {
     ...
     *
     * <p>
     * This method is used to initialize {@link RestPackage#eINSTANCE} when that
    ...
    public static RestPackage init() {
        ...
        RestPackageImpl theRestPackage = registeredRestPackage instanceof RestPackageImpl
                ? (RestPackageImpl) registeredRestPackage
                : new RestPackageImpl();
    ...
    public void initializePackageContents() {
        ...
        WorkflowApiPackage theWorkflowApiPackage = (WorkflowApiPackage) EPackage.Registry.INSTANCE
                .getEPackage(WorkflowApiPackage.eNS_URI);
        ...
        initEClass(ePackageInfoEClass, EPackageInfo.class, "EPackageInfo", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getEPackageInfo_Name(), ecorePackage.getEString(), "name", null, 0, 1, EPackageInfo.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getEPackageInfo_NsURI(), ecorePackage.getEString(), "nsURI", null, 0, 1, EPackageInfo.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getEPackageInfo_NsPrefix(), ecorePackage.getEString(), "nsPrefix", null, 0, 1,
                EPackageInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getEPackageInfo_ClassifierCount(), ecorePackage.getEInt(), "classifierCount", null, 0, 1,
                EPackageInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getEPackageInfo_SubPackageCount(), ecorePackage.getEInt(), "subPackageCount", null, 0, 1,
                EPackageInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(ePackageListResponseEClass, EPackageListResponse.class, "EPackageListResponse", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getEPackageListResponse_Packages(), this.getEPackageInfo(), null, "packages", null, 0, -1,
                EPackageListResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getEPackageListResponse_Total(), ecorePackage.getEInt(), "total", null, 0, 1,
                EPackageListResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getEPackageListResponse_Skip(), ecorePackage.getEInt(), "skip", "0", 0, 1,
                EPackageListResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getEPackageListResponse_Limit(), ecorePackage.getEInt(), "limit", "100", 0, 1,
                EPackageListResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(errorResponseEClass, ErrorResponse.class, "ErrorResponse", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getErrorResponse_Message(), ecorePackage.getEString(), "message", null, 0, 1,
                ErrorResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getErrorResponse_Code(), ecorePackage.getEString(), "code", null, 0, 1, ErrorResponse.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getErrorResponse_Timestamp(), ecorePackage.getEDate(), "timestamp", null, 0, 1,
                ErrorResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(stageTransitionRequestEClass, StageTransitionRequest.class, "StageTransitionRequest", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getStageTransitionRequest_ObjectId(), ecorePackage.getEString(), "objectId", null, 0, 1,
                StageTransitionRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStageTransitionRequest_TargetStage(), ecorePackage.getEString(), "targetStage", null, 0, 1,
                StageTransitionRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(scopeListResponseEClass, ScopeListResponse.class, "ScopeListResponse", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getScopeListResponse_Scopes(), theWorkflowApiPackage.getScope(), null, "scopes", null, 0, -1,
                ScopeListResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
