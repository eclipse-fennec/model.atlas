 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.mgmtapicurio.impl.CreateArtifactImpl#getFirstVersion
 * <em>First Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CreateArtifactImpl extends ArtifactImpl implements CreateArtifact {
    /**
     * The cached value of the '{@link #getFirstVersion() <em>First Version</em>}'
    ...
    public NotificationChain basicSetFirstVersion(Version newFirstVersion, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    MgmtApicurioPackage.CREATE_ARTIFACT__FIRST_VERSION, oldFirstVersion, newFirstVersion);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setFirstVersion(Version newFirstVersion) {
        if (newFirstVersion != firstVersion) {
            ...
            if (firstVersion != null)
                msgs = ((InternalEObject) firstVersion).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - MgmtApicurioPackage.CREATE_ARTIFACT__FIRST_VERSION, null, msgs);
            if (newFirstVersion != null)
                msgs = ((InternalEObject) newFirstVersion).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - MgmtApicurioPackage.CREATE_ARTIFACT__FIRST_VERSION, null, msgs);
            msgs = basicSetFirstVersion(newFirstVersion, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MgmtApicurioPackage.CREATE_ARTIFACT__FIRST_VERSION,
                    newFirstVersion, newFirstVersion));
    }
