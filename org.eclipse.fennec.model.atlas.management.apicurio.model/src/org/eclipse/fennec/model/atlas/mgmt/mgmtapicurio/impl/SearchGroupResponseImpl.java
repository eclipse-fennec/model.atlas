...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Search Group Response</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.model.atlas.mgmt.mgmtapicurio.impl.SearchGroupResponseImpl#getGroups <em>Groups</em>}</li>
 *   <li>{@link org.eclipse.fennec.model.atlas.mgmt.mgmtapicurio.impl.SearchGroupResponseImpl#getCount <em>Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SearchGroupResponseImpl extends MinimalEObjectImpl.Container implements SearchGroupResponse {
	...
	public EList<Group> getGroups() {
		if (groups == null) {
			groups = new EObjectContainmentEList<Group>(Group.class, this, MgmtApicurioPackage.SEARCH_GROUP_RESPONSE__GROUPS);
		}
		return groups;
	}
	...
	public void setCount(int newCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MgmtApicurioPackage.SEARCH_GROUP_RESPONSE__COUNT, oldCount, count));
	}
