...
public class MgmtApicurioPackageImpl extends EPackageImpl implements MgmtApicurioPackage {
     ...
     *
     * <p>
     * This method is used to initialize {@link MgmtApicurioPackage#eINSTANCE} when
    ...
    public static MgmtApicurioPackage init() {
        if (isInited)
            return (MgmtApicurioPackage) EPackage.Registry.INSTANCE.getEPackage(MgmtApicurioPackage.eNS_URI);

        // Obtain or create and register package
        Object registeredMgmtApicurioPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
        MgmtApicurioPackageImpl theMgmtApicurioPackage = registeredMgmtApicurioPackage instanceof MgmtApicurioPackageImpl
                ? (MgmtApicurioPackageImpl) registeredMgmtApicurioPackage
                : new MgmtApicurioPackageImpl();
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getArtifact_ArtifactId(), ecorePackage.getEString(), "artifactId", null, 1, 1, Artifact.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getArtifact_ArtifactType(), this.getArtifactType(), "artifactType", null, 0, 1, Artifact.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getArtifact_Name(), ecorePackage.getEString(), "name", null, 0, 1, Artifact.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getArtifact_Description(), ecorePackage.getEString(), "description", null, 0, 1, Artifact.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getArtifact_Labels(), this.getLabels(), null, "labels", null, 0, -1, Artifact.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(createArtifactEClass, CreateArtifact.class, "CreateArtifact", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getCreateArtifact_FirstVersion(), this.getVersion(), null, "firstVersion", null, 0, 1,
                CreateArtifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(createArtifactVersionEClass, CreateArtifactVersion.class, "CreateArtifactVersion", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(contentEClass, Content.class, "Content", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getContent_ContentType(), ecorePackage.getEString(), "contentType", null, 1, 1, Content.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getContent_Content(), ecorePackage.getEString(), "content", null, 1, 1, Content.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getContent_References(), this.getArtifactReference(), null, "references", null, 0, -1,
                Content.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(versionEClass, Version.class, "Version", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getVersion_Version(), ecorePackage.getEString(), "version", null, 0, 1, Version.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getVersion_Content(), this.getContent(), null, "content", null, 1, 1, Version.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getVersion_Name(), ecorePackage.getEString(), "name", null, 0, 1, Version.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getVersion_Description(), ecorePackage.getEString(), "description", null, 0, 1, Version.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getVersion_Branches(), ecorePackage.getEString(), "branches", null, 0, -1, Version.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getVersion_IsDraft(), ecorePackage.getEBoolean(), "isDraft", null, 0, 1, Version.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getVersion_Labels(), this.getLabels(), null, "labels", null, 0, -1, Version.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);

        initEClass(artifactReferenceEClass, ArtifactReference.class, "ArtifactReference", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getArtifactReference_GroupId(), ecorePackage.getEString(), "groupId", null, 1, 1,
                ArtifactReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getArtifactReference_ArtifactId(), ecorePackage.getEString(), "artifactId", null, 1, 1,
                ArtifactReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getArtifactReference_Name(), ecorePackage.getEString(), "name", null, 1, 1,
                ArtifactReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getArtifactReference_Version(), ecorePackage.getEString(), "version", null, 0, 1,
                ArtifactReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(searchedArtifactEClass, SearchedArtifact.class, "SearchedArtifact", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSearchedArtifact_CreatedOn(), ecorePackage.getEString(), "createdOn", null, 1, 1,
                SearchedArtifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSearchedArtifact_Owner(), ecorePackage.getEString(), "owner", null, 1, 1,
                SearchedArtifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSearchedArtifact_ModifiedOn(), ecorePackage.getEString(), "modifiedOn", null, 0, 1,
                SearchedArtifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSearchedArtifact_ModifiedBy(), ecorePackage.getEString(), "modifiedBy", null, 0, 1,
                SearchedArtifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSearchedArtifact_GroupId(), ecorePackage.getEString(), "groupId", null, 0, 1,
                SearchedArtifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(searchResponseEClass, SearchResponse.class, "SearchResponse", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSearchResponse_Artifacts(), this.getSearchedArtifact(), null, "artifacts", null, 0, -1,
                SearchResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSearchResponse_Count(), ecorePackage.getEInt(), "count", null, 1, 1, SearchResponse.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(labelsEClass, Map.Entry.class, "Labels", !IS_ABSTRACT, !IS_INTERFACE, !IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getLabels_Key(), ecorePackage.getEString(), "key", null, 0, 1, Map.Entry.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getLabels_Value(), ecorePackage.getEString(), "value", null, 0, 1, Map.Entry.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(searchVersionResponseEClass, SearchVersionResponse.class, "SearchVersionResponse", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSearchVersionResponse_Versions(), this.getSearchedVersion(), null, "versions", null, 0, -1,
                SearchVersionResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSearchVersionResponse_Count(), ecorePackage.getEInt(), "count", null, 1, 1,
                SearchVersionResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(searchedVersionEClass, SearchedVersion.class, "SearchedVersion", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSearchedVersion_GlobalId(), ecorePackage.getEString(), "globalId", null, 1, 1,
                SearchedVersion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSearchedVersion_Version(), ecorePackage.getEString(), "version", null, 1, 1,
                SearchedVersion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSearchedVersion_ContentId(), ecorePackage.getEString(), "contentId", null, 1, 1,
                SearchedVersion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSearchedVersion_State(), this.getVersionStateType(), "state", null, 1, 1,
                SearchedVersion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(groupEClass, Group.class, "Group", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getGroup_GroupId(), ecorePackage.getEString(), "groupId", null, 1, 1, Group.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGroup_CreatedOn(), ecorePackage.getEString(), "createdOn", null, 1, 1, Group.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGroup_Owner(), ecorePackage.getEString(), "owner", null, 1, 1, Group.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGroup_ModifiedOn(), ecorePackage.getEString(), "modifiedOn", null, 1, 1, Group.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGroup_ModifiedBy(), ecorePackage.getEString(), "modifiedBy", null, 1, 1, Group.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGroup_Description(), ecorePackage.getEString(), "description", null, 0, 1, Group.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getGroup_Labels(), this.getLabels(), null, "labels", null, 0, -1, Group.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);

        initEClass(searchGroupResponseEClass, SearchGroupResponse.class, "SearchGroupResponse", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSearchGroupResponse_Groups(), this.getGroup(), null, "groups", null, 0, -1,
                SearchGroupResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSearchGroupResponse_Count(), ecorePackage.getEInt(), "count", null, 1, 1,
                SearchGroupResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    /**
     * Initializes the annotations for <b>Version</b>. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    protected void createVersionAnnotations() {
        ...
        addAnnotation(this, source, new String[] { "value", "1.0" });
    }
    ...
    protected void createGenModelAnnotations() {
        ...
        addAnnotation(this, source, new String[] { "complianceLevel", "17.0", "oSGiCompatible", "true", "basePackage",
                "org.eclipse.fennec.model.atlas.mgmt", "resource", "XMI", "copyrightText",
                "Copyright (c) 2012 - 2025 Data In Motion and others.\nAll rights reserved.\n\nThis program and the accompanying materials are made\navailable under the terms of the Eclipse Public License 2.0\nwhich is available at https://www.eclipse.org/legal/epl-2.0/\n\nSPDX-License-Identifier: EPL-2.0\n\nContributors:\n    Data In Motion - initial API and implementation" });
        addAnnotation(createArtifactEClass, source, new String[] { "documentation",
                "When you first create an artifact in Apicurio, this is the object you should use." });
        addAnnotation(createArtifactVersionEClass, source,
                new String[] { "documentation", "Creates a new version of the artifact by uploading new content." });
        addAnnotation(getContent_ContentType(), source,
                new String[] { "documentation", "The content-type, such as application/json or text/xml." });
        addAnnotation(getContent_Content(), source, new String[] { "documentation",
                "Raw content of the artifact version or a valid (and accessible) URL where the content can be found." });
        addAnnotation(getVersion_Version(), source, new String[] { "documentation",
        ...
        addAnnotation(artifactTypeEEnum.getELiterals().get(4), source,
                new String[] { "documentation", "Apache Avro schema" });
        addAnnotation(artifactTypeEEnum.getELiterals().get(6), source,
                new String[] { "documentation", "Apache Kafka Connect schema" });
        addAnnotation(artifactTypeEEnum.getELiterals().get(8), source,
                new String[] { "documentation", "Google protocol buffers schema" });
        addAnnotation(artifactTypeEEnum.getELiterals().get(9), source,
                new String[] { "documentation", "Web Service Definition Language" });
        addAnnotation(getSearchResponse_Count(), source, new String[] { "documentation",
        ...
        addAnnotation(getSearchVersionResponse_Count(), source, new String[] { "documentation",
                "The total number of artifacts that matched the query that produced the result set (may be more than the number of artifacts in the result set)." });
        addAnnotation(getSearchGroupResponse_Count(), source, new String[] { "documentation",
                "The total number of artifacts that matched the query that produced the result set (may be more than the number of artifacts in the result set)." });
    }
