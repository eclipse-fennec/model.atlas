...
import org.eclipse.fennec.model.atlas.mgmt.mgmtapicurio.impl.MgmtApicurioPackageImpl;

import org.eclipse.fennec.model.atlas.mgmt.mgmtapicurio.util.MgmtApicurioResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.model.atlas.mgmt.mgmtapicurio\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.osgi.service.condition.Condition\"" , "uses:=org.osgi.service.condition" })
public class MgmtApicurioConfigurationComponent {

	private static final System.Logger LOG = System.getLogger(MgmtApicurioConfigurationComponent.class.getName());
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(MgmtApicurioPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(MgmtApicurioPackage.eNS_URI, ePackage);
		}
