 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.mgmtapicurio.impl.ArtifactImpl#getArtifactId
 * <em>Artifact Id</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.mgmtapicurio.impl.ArtifactImpl#getArtifactType
 * <em>Artifact Type</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.mgmtapicurio.impl.ArtifactImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.mgmtapicurio.impl.ArtifactImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link org.eclipse.fennec.model.atlas.mgmt.mgmtapicurio.impl.ArtifactImpl#getLabels
 * <em>Labels</em>}</li>
 * </ul>
 *
 * @generated
...
public class ArtifactImpl extends MinimalEObjectImpl.Container implements Artifact {
    ...
    /**
     * The default value of the '{@link #getArtifactType() <em>Artifact Type</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getArtifactType()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getArtifactType() <em>Artifact Type</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getArtifactType()
     * @generated
    ...
    public void setArtifactId(String newArtifactId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MgmtApicurioPackage.ARTIFACT__ARTIFACT_ID,
    ...
    public void setArtifactType(ArtifactType newArtifactType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MgmtApicurioPackage.ARTIFACT__ARTIFACT_TYPE,
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MgmtApicurioPackage.ARTIFACT__DESCRIPTION,
    ...
    public EMap<String, String> getLabels() {
        if (labels == null) {
            labels = new EcoreEMap<String, String>(MgmtApicurioPackage.Literals.LABELS, LabelsImpl.class, this,
                    MgmtApicurioPackage.ARTIFACT__LABELS);
        }
        return labels;
    }
