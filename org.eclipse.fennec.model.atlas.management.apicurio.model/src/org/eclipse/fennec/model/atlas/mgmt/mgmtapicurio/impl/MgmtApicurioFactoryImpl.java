...
public class MgmtApicurioFactoryImpl extends EFactoryImpl implements MgmtApicurioFactory {
    ...
    public static MgmtApicurioFactory init() {
        try {
            MgmtApicurioFactory theMgmtApicurioFactory = (MgmtApicurioFactory) EPackage.Registry.INSTANCE
                    .getEFactory(MgmtApicurioPackage.eNS_URI);
    ...
    public EObject create(EClass eClass) {
        ...
        case MgmtApicurioPackage.CREATE_ARTIFACT:
            return createCreateArtifact();
        case MgmtApicurioPackage.CREATE_ARTIFACT_VERSION:
            return createCreateArtifactVersion();
