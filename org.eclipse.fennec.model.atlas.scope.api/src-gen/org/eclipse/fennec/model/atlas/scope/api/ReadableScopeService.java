...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Readable Scope Service</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
 ...
 *
 *
 * @see org.eclipse.fennec.model.atlas.scope.api.ScopeApiPackage#getReadableScopeService()
 * @model interface="true" abstract="true"
 * @generated
 */
@ProviderType
public interface ReadableScopeService<T extends EObject> {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * A read-only descriptor of the scope this service reads from: its name, description, parent scope, and the registries it exposes, with its stages (without the workflow transition detail). @return the scope info; never {@code null}
	 * <!-- end-model-doc -->
	 * @model kind="operation"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Final-stage view of a registry
	 * <!-- end-model-doc -->
	 * @model registryRequired="true"
	 * @generated
	 */
	ReadableRegistryView<T> registryView(String registry);

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * explicit-stage view; inheritance reads through to the parent hierarchy's final stage server-side
	 * <!-- end-model-doc -->
	 * @model registryRequired="true" stageRequired="true"
	 * @generated
	 */
	ReadableRegistryView<T> registryView(String registry, String stage);

} // ReadableScopeService
