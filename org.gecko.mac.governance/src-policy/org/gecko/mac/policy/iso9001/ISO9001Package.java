 ...
 */
package org.gecko.mac.policy.iso9001;
 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see org.gecko.mac.policy.iso9001.ISO9001Factory
 * @model kind="package"
 * @generated
 */
@ProviderType
@EPackage(uri = ISO9001Package.eNS_URI, genModel = "/../policies.genmodel", genModelSourceLocations = {"model/policies/policies.genmodel","org.gecko.mac.governance/model/policies/policies.genmodel"}, ecore="/../din-iso9001.ecore", ecoreSourceLocations="/model/policies/din-iso9001.ecore")
public interface ISO9001Package extends org.eclipse.emf.ecore.EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "https://datainmotion.com/mac/policy/iso_9001/1.0.0";
	 ...
	 * @generated
	 */
	ISO9001Package eINSTANCE = org.gecko.mac.policy.iso9001.impl.ISO9001PackageImpl.init();

	/**
	 * The meta object id for the '{@link org.gecko.mac.policy.iso9001.impl.ISO9001PolicyCheckImpl <em>Policy Check</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.gecko.mac.policy.iso9001.impl.ISO9001PolicyCheckImpl
	 * @see org.gecko.mac.policy.iso9001.impl.ISO9001PackageImpl#getISO9001PolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link org.gecko.mac.policy.iso9001.ISO9001PolicyCheck <em>Policy Check</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Policy Check</em>'.
	 * @see org.gecko.mac.policy.iso9001.ISO9001PolicyCheck
	 * @generated
	 */
	EClass getISO9001PolicyCheck();

	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.iso9001.ISO9001PolicyCheck#isProcessApproachApplied <em>Process Approach Applied</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Process Approach Applied</em>'.
	 * @see org.gecko.mac.policy.iso9001.ISO9001PolicyCheck#isProcessApproachApplied()
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.iso9001.ISO9001PolicyCheck#isDocumentedInformationMaintained <em>Documented Information Maintained</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Documented Information Maintained</em>'.
	 * @see org.gecko.mac.policy.iso9001.ISO9001PolicyCheck#isDocumentedInformationMaintained()
	 * @see #getISO9001PolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.iso9001.ISO9001PolicyCheck#isCustomerFocusDemonstrated <em>Customer Focus Demonstrated</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Customer Focus Demonstrated</em>'.
	 * @see org.gecko.mac.policy.iso9001.ISO9001PolicyCheck#isCustomerFocusDemonstrated()
	 * @see #getISO9001PolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.iso9001.ISO9001PolicyCheck#isNonconformityProcessExists <em>Nonconformity Process Exists</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Nonconformity Process Exists</em>'.
	 * @see org.gecko.mac.policy.iso9001.ISO9001PolicyCheck#isNonconformityProcessExists()
	 * @see #getISO9001PolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.iso9001.ISO9001PolicyCheck#isResourceAndCompetenceVerified <em>Resource And Competence Verified</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Resource And Competence Verified</em>'.
	 * @see org.gecko.mac.policy.iso9001.ISO9001PolicyCheck#isResourceAndCompetenceVerified()
	 * @see #getISO9001PolicyCheck()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.gecko.mac.policy.iso9001.impl.ISO9001PolicyCheckImpl <em>Policy Check</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.gecko.mac.policy.iso9001.impl.ISO9001PolicyCheckImpl
		 * @see org.gecko.mac.policy.iso9001.impl.ISO9001PackageImpl#getISO9001PolicyCheck()
