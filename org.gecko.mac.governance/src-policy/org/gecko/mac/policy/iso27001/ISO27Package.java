 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see org.gecko.mac.policy.iso27001.ISO27Factory
 * @model kind="package"
 * @generated
 */
@ProviderType
@EPackage(uri = ISO27Package.eNS_URI, genModel = "/../policies.genmodel", genModelSourceLocations = {"model/policies/policies.genmodel","org.gecko.mac.governance/model/policies/policies.genmodel"}, ecore="/../iso27001.ecore", ecoreSourceLocations="/model/policies/iso27001.ecore")
public interface ISO27Package extends org.eclipse.emf.ecore.EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "https://datainmotion.com/mac/policy/iso_27001/1.0.0";
	 ...
	 * @generated
	 */
	ISO27Package eINSTANCE = org.gecko.mac.policy.iso27001.impl.ISO27PackageImpl.init();

	/**
	 * The meta object id for the '{@link org.gecko.mac.policy.iso27001.impl.ISO27001PolicyCheckImpl <em>ISO27001 Policy Check</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.gecko.mac.policy.iso27001.impl.ISO27001PolicyCheckImpl
	 * @see org.gecko.mac.policy.iso27001.impl.ISO27PackageImpl#getISO27001PolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link org.gecko.mac.policy.iso27001.ISO27001PolicyCheck <em>ISO27001 Policy Check</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>ISO27001 Policy Check</em>'.
	 * @see org.gecko.mac.policy.iso27001.ISO27001PolicyCheck
	 * @generated
	 */
	EClass getISO27001PolicyCheck();

	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.iso27001.ISO27001PolicyCheck#isNetworkControlImplemented <em>Network Control Implemented</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Network Control Implemented</em>'.
	 * @see org.gecko.mac.policy.iso27001.ISO27001PolicyCheck#isNetworkControlImplemented()
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.iso27001.ISO27001PolicyCheck#isAccessControlVerified <em>Access Control Verified</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Access Control Verified</em>'.
	 * @see org.gecko.mac.policy.iso27001.ISO27001PolicyCheck#isAccessControlVerified()
	 * @see #getISO27001PolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.iso27001.ISO27001PolicyCheck#isLoggingAndMonitoringActive <em>Logging And Monitoring Active</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Logging And Monitoring Active</em>'.
	 * @see org.gecko.mac.policy.iso27001.ISO27001PolicyCheck#isLoggingAndMonitoringActive()
	 * @see #getISO27001PolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.iso27001.ISO27001PolicyCheck#isAssetManagementCompliant <em>Asset Management Compliant</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Asset Management Compliant</em>'.
	 * @see org.gecko.mac.policy.iso27001.ISO27001PolicyCheck#isAssetManagementCompliant()
	 * @see #getISO27001PolicyCheck()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.gecko.mac.policy.iso27001.impl.ISO27001PolicyCheckImpl <em>ISO27001 Policy Check</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.gecko.mac.policy.iso27001.impl.ISO27001PolicyCheckImpl
		 * @see org.gecko.mac.policy.iso27001.impl.ISO27PackageImpl#getISO27001PolicyCheck()
