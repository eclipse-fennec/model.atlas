 ...
 * </p>
 * <ul>
 *   <li>{@link org.gecko.mac.policy.gdpr.GDPRPolicyCheck#isContainsPersonalData <em>Contains Personal Data</em>}</li>
 *   <li>{@link org.gecko.mac.policy.gdpr.GDPRPolicyCheck#getLegalBasisForProcessing <em>Legal Basis For Processing</em>}</li>
 *   <li>{@link org.gecko.mac.policy.gdpr.GDPRPolicyCheck#isDataMinimizationApplied <em>Data Minimization Applied</em>}</li>
 *   <li>{@link org.gecko.mac.policy.gdpr.GDPRPolicyCheck#isPurposeLimitationMet <em>Purpose Limitation Met</em>}</li>
 * </ul>
 *
 * @see org.gecko.mac.policy.gdpr.GDPRPackage#getGDPRPolicyCheck()
 * @model
 * @generated
 */
@ProviderType
public interface GDPRPolicyCheck extends ComplianceCheckResult {
	 ...
	 * @see org.gecko.mac.policy.gdpr.GDPRPackage#getGDPRPolicyCheck_ContainsPersonalData()
	...
	/**
	 * Sets the value of the '{@link org.gecko.mac.policy.gdpr.GDPRPolicyCheck#isContainsPersonalData <em>Contains Personal Data</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link org.gecko.mac.policy.gdpr.LegalBasis}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see org.gecko.mac.policy.gdpr.GDPRPackage#getGDPRPolicyCheck_LegalBasisForProcessing()
	...
	/**
	 * Sets the value of the '{@link org.gecko.mac.policy.gdpr.GDPRPolicyCheck#getLegalBasisForProcessing <em>Legal Basis For Processing</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.gecko.mac.policy.gdpr.GDPRPackage#getGDPRPolicyCheck_DataMinimizationApplied()
	...
	/**
	 * Sets the value of the '{@link org.gecko.mac.policy.gdpr.GDPRPolicyCheck#isDataMinimizationApplied <em>Data Minimization Applied</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.gecko.mac.policy.gdpr.GDPRPackage#getGDPRPolicyCheck_PurposeLimitationMet()
	 * @model default="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.gecko.mac.policy.gdpr.GDPRPolicyCheck#isPurposeLimitationMet <em>Purpose Limitation Met</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
