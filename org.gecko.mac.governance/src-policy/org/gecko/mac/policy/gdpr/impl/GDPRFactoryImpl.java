...
public class GDPRFactoryImpl extends EFactoryImpl implements GDPRFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case GDPRPackage.GDPR_POLICY_CHECK: return createGDPRPolicyCheck();
			default:
	 ...
	 */
	@Override
	public GDPRPolicyCheck createGDPRPolicyCheck() {
		GDPRPolicyCheckImpl gdprPolicyCheck = new GDPRPolicyCheckImpl();
		return gdprPolicyCheck;
	}
