 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see org.gecko.mac.policy.opendata.OpenDataFactory
 * @model kind="package"
 * @generated
 */
@ProviderType
@EPackage(uri = OpenDataPackage.eNS_URI, genModel = "/../policies.genmodel", genModelSourceLocations = {"model/policies/policies.genmodel","org.gecko.mac.governance/model/policies/policies.genmodel"}, ecore="/../opendata.ecore", ecoreSourceLocations="/model/policies/opendata.ecore")
public interface OpenDataPackage extends org.eclipse.emf.ecore.EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "https://datainmotion.com/mac/policy/open_data/1.0.0";
	 ...
	 * @generated
	 */
	OpenDataPackage eINSTANCE = org.gecko.mac.policy.opendata.impl.OpenDataPackageImpl.init();

	/**
	 * The meta object id for the '{@link org.gecko.mac.policy.opendata.impl.OpenDataPolicyCheckImpl <em>Policy Check</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.gecko.mac.policy.opendata.impl.OpenDataPolicyCheckImpl
	 * @see org.gecko.mac.policy.opendata.impl.OpenDataPackageImpl#getOpenDataPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link org.gecko.mac.policy.opendata.OpenDataLicense <em>License</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.gecko.mac.policy.opendata.OpenDataLicense
	 * @see org.gecko.mac.policy.opendata.impl.OpenDataPackageImpl#getOpenDataLicense()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link org.gecko.mac.policy.opendata.OpenDataPolicyCheck <em>Policy Check</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Policy Check</em>'.
	 * @see org.gecko.mac.policy.opendata.OpenDataPolicyCheck
	 * @generated
	 */
	EClass getOpenDataPolicyCheck();

	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.opendata.OpenDataPolicyCheck#isPiiAnonymizationVerified <em>Pii Anonymization Verified</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Pii Anonymization Verified</em>'.
	 * @see org.gecko.mac.policy.opendata.OpenDataPolicyCheck#isPiiAnonymizationVerified()
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.opendata.OpenDataPolicyCheck#getLicenseType <em>License Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>License Type</em>'.
	 * @see org.gecko.mac.policy.opendata.OpenDataPolicyCheck#getLicenseType()
	 * @see #getOpenDataPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.opendata.OpenDataPolicyCheck#isIsMachineReadable <em>Is Machine Readable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Is Machine Readable</em>'.
	 * @see org.gecko.mac.policy.opendata.OpenDataPolicyCheck#isIsMachineReadable()
	 * @see #getOpenDataPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.opendata.OpenDataPolicyCheck#isHasPublicEndpoint <em>Has Public Endpoint</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Has Public Endpoint</em>'.
	 * @see org.gecko.mac.policy.opendata.OpenDataPolicyCheck#isHasPublicEndpoint()
	 * @see #getOpenDataPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for enum '{@link org.gecko.mac.policy.opendata.OpenDataLicense <em>License</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.gecko.mac.policy.opendata.impl.OpenDataPolicyCheckImpl <em>Policy Check</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.gecko.mac.policy.opendata.impl.OpenDataPolicyCheckImpl
		 * @see org.gecko.mac.policy.opendata.impl.OpenDataPackageImpl#getOpenDataPolicyCheck()
		...
		/**
		 * The meta object literal for the '{@link org.gecko.mac.policy.opendata.OpenDataLicense <em>License</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.gecko.mac.policy.opendata.OpenDataLicense
		 * @see org.gecko.mac.policy.opendata.impl.OpenDataPackageImpl#getOpenDataLicense()
