 ...
 */
package org.gecko.mac.policy.euaiact;
 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see org.gecko.mac.policy.euaiact.EUAIFactory
 * @model kind="package"
 * @generated
 */
@ProviderType
@EPackage(uri = EUAIPackage.eNS_URI, genModel = "/../policies.genmodel", genModelSourceLocations = {"model/policies/policies.genmodel","org.gecko.mac.governance/model/policies/policies.genmodel"}, ecore="/../eu-ai-act.ecore", ecoreSourceLocations="/model/policies/eu-ai-act.ecore")
public interface EUAIPackage extends org.eclipse.emf.ecore.EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "https://datainmotion.com/mac/policy/eu_ai_act/1.0.0";
	 ...
	 * @generated
	 */
	EUAIPackage eINSTANCE = org.gecko.mac.policy.euaiact.impl.EUAIPackageImpl.init();

	/**
	 * The meta object id for the '{@link org.gecko.mac.policy.euaiact.impl.EUAIActPolicyCheckImpl <em>Act Policy Check</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.gecko.mac.policy.euaiact.impl.EUAIActPolicyCheckImpl
	 * @see org.gecko.mac.policy.euaiact.impl.EUAIPackageImpl#getEUAIActPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link org.gecko.mac.policy.euaiact.AIActRiskLevel <em>AI Act Risk Level</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.gecko.mac.policy.euaiact.AIActRiskLevel
	 * @see org.gecko.mac.policy.euaiact.impl.EUAIPackageImpl#getAIActRiskLevel()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link org.gecko.mac.policy.euaiact.EUAIActPolicyCheck <em>Act Policy Check</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Act Policy Check</em>'.
	 * @see org.gecko.mac.policy.euaiact.EUAIActPolicyCheck
	 * @generated
	 */
	EClass getEUAIActPolicyCheck();

	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.euaiact.EUAIActPolicyCheck#getRiskLevel <em>Risk Level</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Risk Level</em>'.
	 * @see org.gecko.mac.policy.euaiact.EUAIActPolicyCheck#getRiskLevel()
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.euaiact.EUAIActPolicyCheck#isIsHighRiskAnnexIII <em>Is High Risk Annex III</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Is High Risk Annex III</em>'.
	 * @see org.gecko.mac.policy.euaiact.EUAIActPolicyCheck#isIsHighRiskAnnexIII()
	 * @see #getEUAIActPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.euaiact.EUAIActPolicyCheck#isThreatensHealthSafetyOrRights <em>Threatens Health Safety Or Rights</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Threatens Health Safety Or Rights</em>'.
	 * @see org.gecko.mac.policy.euaiact.EUAIActPolicyCheck#isThreatensHealthSafetyOrRights()
	 * @see #getEUAIActPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.gecko.mac.policy.euaiact.EUAIActPolicyCheck#isIsUnacceptableRiskArticle5 <em>Is Unacceptable Risk Article5</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Is Unacceptable Risk Article5</em>'.
	 * @see org.gecko.mac.policy.euaiact.EUAIActPolicyCheck#isIsUnacceptableRiskArticle5()
	 * @see #getEUAIActPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for enum '{@link org.gecko.mac.policy.euaiact.AIActRiskLevel <em>AI Act Risk Level</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.gecko.mac.policy.euaiact.impl.EUAIActPolicyCheckImpl <em>Act Policy Check</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.gecko.mac.policy.euaiact.impl.EUAIActPolicyCheckImpl
		 * @see org.gecko.mac.policy.euaiact.impl.EUAIPackageImpl#getEUAIActPolicyCheck()
		...
		/**
		 * The meta object literal for the '{@link org.gecko.mac.policy.euaiact.AIActRiskLevel <em>AI Act Risk Level</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.gecko.mac.policy.euaiact.AIActRiskLevel
		 * @see org.gecko.mac.policy.euaiact.impl.EUAIPackageImpl#getAIActRiskLevel()
