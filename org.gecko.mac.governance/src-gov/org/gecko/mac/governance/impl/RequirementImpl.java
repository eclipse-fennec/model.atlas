...
import org.gecko.mac.governance.Capability;
import org.gecko.mac.governance.GovernancePackage;
import org.gecko.mac.governance.Requirement;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.gecko.mac.governance.impl.RequirementImpl#getCapability <em>Capability</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementImpl extends ComponentDependencyImpl implements Requirement {
	/**
	...
	public EList<Capability> getCapability() {
		if (capability == null) {
			capability = new EObjectWithInverseResolvingEList.ManyInverse<Capability>(Capability.class, this, GovernancePackage.REQUIREMENT__CAPABILITY, GovernancePackage.CAPABILITY__REQUIREMENT);
		}
		return capability;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GovernancePackage.REQUIREMENT__CAPABILITY:
