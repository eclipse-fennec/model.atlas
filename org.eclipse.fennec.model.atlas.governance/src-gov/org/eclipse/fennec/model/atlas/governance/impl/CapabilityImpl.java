 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.model.atlas.governance.impl.CapabilityImpl#getRequirement <em>Requirement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CapabilityImpl extends ComponentDependencyImpl implements Capability {
	/**
	...
	protected EClass eStaticClass() {
		return GovernancePackage.Literals.CAPABILITY;
	}
	...
	public EList<Requirement> getRequirement() {
		if (requirement == null) {
			requirement = new EObjectWithInverseResolvingEList.ManyInverse<Requirement>(Requirement.class, this, GovernancePackage.CAPABILITY__REQUIREMENT, GovernancePackage.REQUIREMENT__CAPABILITY);
		}
		return requirement;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GovernancePackage.CAPABILITY__REQUIREMENT:
