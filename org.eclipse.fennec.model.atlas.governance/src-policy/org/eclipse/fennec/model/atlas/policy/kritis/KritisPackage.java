 ...
 */
package org.eclipse.fennec.model.atlas.policy.kritis;
 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see org.eclipse.fennec.model.atlas.policy.kritis.KritisFactory
 * @model kind="package"
 * @generated
 */
@ProviderType
@EPackage(uri = KritisPackage.eNS_URI, genModel = "/../policies.genmodel", genModelSourceLocations = {"model/policies/policies.genmodel","org.eclipse.fennec.model.atlas.governance/model/policies/policies.genmodel"}, ecore="/../kritis.ecore", ecoreSourceLocations="/model/policies/kritis.ecore")
public interface KritisPackage extends org.eclipse.emf.ecore.EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "https://eclipse.org/fennec/model/atlas/policy/kritis/1.0.0";
	 ...
	 * @generated
	 */
	KritisPackage eINSTANCE = org.eclipse.fennec.model.atlas.policy.kritis.impl.KritisPackageImpl.init();

	/**
	 * The meta object id for the '{@link org.eclipse.fennec.model.atlas.policy.kritis.impl.KRITISPolicyCheckImpl <em>KRITIS Policy Check</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.fennec.model.atlas.policy.kritis.impl.KRITISPolicyCheckImpl
	 * @see org.eclipse.fennec.model.atlas.policy.kritis.impl.KritisPackageImpl#getKRITISPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link org.eclipse.fennec.model.atlas.policy.kritis.KRITISPolicyCheck <em>KRITIS Policy Check</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>KRITIS Policy Check</em>'.
	 * @see org.eclipse.fennec.model.atlas.policy.kritis.KRITISPolicyCheck
	 * @generated
	 */
	EClass getKRITISPolicyCheck();

	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.fennec.model.atlas.policy.kritis.KRITISPolicyCheck#isResilienceVerified <em>Resilience Verified</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Resilience Verified</em>'.
	 * @see org.eclipse.fennec.model.atlas.policy.kritis.KRITISPolicyCheck#isResilienceVerified()
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.fennec.model.atlas.policy.kritis.KRITISPolicyCheck#isIncidentResponseReady <em>Incident Response Ready</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Incident Response Ready</em>'.
	 * @see org.eclipse.fennec.model.atlas.policy.kritis.KRITISPolicyCheck#isIncidentResponseReady()
	 * @see #getKRITISPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.fennec.model.atlas.policy.kritis.KRITISPolicyCheck#isSupplyChainSecure <em>Supply Chain Secure</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Supply Chain Secure</em>'.
	 * @see org.eclipse.fennec.model.atlas.policy.kritis.KRITISPolicyCheck#isSupplyChainSecure()
	 * @see #getKRITISPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.fennec.model.atlas.policy.kritis.KRITISPolicyCheck#isSystemHardeningApplied <em>System Hardening Applied</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>System Hardening Applied</em>'.
	 * @see org.eclipse.fennec.model.atlas.policy.kritis.KRITISPolicyCheck#isSystemHardeningApplied()
	 * @see #getKRITISPolicyCheck()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.eclipse.fennec.model.atlas.policy.kritis.impl.KRITISPolicyCheckImpl <em>KRITIS Policy Check</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.fennec.model.atlas.policy.kritis.impl.KRITISPolicyCheckImpl
		 * @see org.eclipse.fennec.model.atlas.policy.kritis.impl.KritisPackageImpl#getKRITISPolicyCheck()
