 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see org.eclipse.fennec.model.atlas.policy.gdpr.GDPRFactory
 * @model kind="package"
 * @generated
 */
@ProviderType
@EPackage(uri = GDPRPackage.eNS_URI, genModel = "/../policies.genmodel", genModelSourceLocations = {"model/policies/policies.genmodel","org.eclipse.fennec.model.atlas.governance/model/policies/policies.genmodel"}, ecore="/../gdpr.ecore", ecoreSourceLocations="/model/policies/gdpr.ecore")
public interface GDPRPackage extends org.eclipse.emf.ecore.EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "https://eclipse.org/fennec/model/atlas/policy/gdpr/1.0.0";
	 ...
	 * @generated
	 */
	GDPRPackage eINSTANCE = org.eclipse.fennec.model.atlas.policy.gdpr.impl.GDPRPackageImpl.init();

	/**
	 * The meta object id for the '{@link org.eclipse.fennec.model.atlas.policy.gdpr.impl.GDPRPolicyCheckImpl <em>Policy Check</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.fennec.model.atlas.policy.gdpr.impl.GDPRPolicyCheckImpl
	 * @see org.eclipse.fennec.model.atlas.policy.gdpr.impl.GDPRPackageImpl#getGDPRPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link org.eclipse.fennec.model.atlas.policy.gdpr.LegalBasis <em>Legal Basis</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.fennec.model.atlas.policy.gdpr.LegalBasis
	 * @see org.eclipse.fennec.model.atlas.policy.gdpr.impl.GDPRPackageImpl#getLegalBasis()
	 * @generated
	 */
	int LEGAL_BASIS = 1;
	...
	/**
	 * Returns the meta object for class '{@link org.eclipse.fennec.model.atlas.policy.gdpr.GDPRPolicyCheck <em>Policy Check</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Policy Check</em>'.
	 * @see org.eclipse.fennec.model.atlas.policy.gdpr.GDPRPolicyCheck
	 * @generated
	 */
	EClass getGDPRPolicyCheck();

	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.fennec.model.atlas.policy.gdpr.GDPRPolicyCheck#isContainsPersonalData <em>Contains Personal Data</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Contains Personal Data</em>'.
	 * @see org.eclipse.fennec.model.atlas.policy.gdpr.GDPRPolicyCheck#isContainsPersonalData()
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.fennec.model.atlas.policy.gdpr.GDPRPolicyCheck#getLegalBasisForProcessing <em>Legal Basis For Processing</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Legal Basis For Processing</em>'.
	 * @see org.eclipse.fennec.model.atlas.policy.gdpr.GDPRPolicyCheck#getLegalBasisForProcessing()
	 * @see #getGDPRPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.fennec.model.atlas.policy.gdpr.GDPRPolicyCheck#isDataMinimizationApplied <em>Data Minimization Applied</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Data Minimization Applied</em>'.
	 * @see org.eclipse.fennec.model.atlas.policy.gdpr.GDPRPolicyCheck#isDataMinimizationApplied()
	 * @see #getGDPRPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.fennec.model.atlas.policy.gdpr.GDPRPolicyCheck#isPurposeLimitationMet <em>Purpose Limitation Met</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Purpose Limitation Met</em>'.
	 * @see org.eclipse.fennec.model.atlas.policy.gdpr.GDPRPolicyCheck#isPurposeLimitationMet()
	 * @see #getGDPRPolicyCheck()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for enum '{@link org.eclipse.fennec.model.atlas.policy.gdpr.LegalBasis <em>Legal Basis</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.eclipse.fennec.model.atlas.policy.gdpr.impl.GDPRPolicyCheckImpl <em>Policy Check</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.fennec.model.atlas.policy.gdpr.impl.GDPRPolicyCheckImpl
		 * @see org.eclipse.fennec.model.atlas.policy.gdpr.impl.GDPRPackageImpl#getGDPRPolicyCheck()
		...
		/**
		 * The meta object literal for the '{@link org.eclipse.fennec.model.atlas.policy.gdpr.LegalBasis <em>Legal Basis</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.fennec.model.atlas.policy.gdpr.LegalBasis
		 * @see org.eclipse.fennec.model.atlas.policy.gdpr.impl.GDPRPackageImpl#getLegalBasis()
