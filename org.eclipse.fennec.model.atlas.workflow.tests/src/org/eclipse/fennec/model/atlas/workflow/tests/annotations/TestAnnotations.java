...
public class TestAnnotations {
     ...
     *
     * <p>Combines WorkflowStorageSetup with a BasicStorageRegistry configuration.</p>
     */
     ...
     *
     * <p>Configures file storage and the EPackagePostReleaseActionService for testing
     * post-release actions like EPackage registration in the OSGi EMF registry.</p>
     */
    @RegistryConfiguration
    @WithFactoryConfiguration(factoryPid = PID_FILE_STORAGE, name = "file-storage", location = "?", properties = {
        @Property(key = "workspace.folder", value = "%s/file-storage", templateArguments = {
