 ...
 * @generated
 */
public class JPAMappingSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JPAMappingPackage.JPA_MAPPING_CONFIG: {
				JpaMappingConfig jpaMappingConfig = (JpaMappingConfig)theEObject;
				T result = caseJpaMappingConfig(jpaMappingConfig);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JPAMappingPackage.DATA_SOURCE_CONFIG: {
				DataSourceConfig dataSourceConfig = (DataSourceConfig)theEObject;
				T result = caseDataSourceConfig(dataSourceConfig);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JPAMappingPackage.TABLE_MAPPING: {
				TableMapping tableMapping = (TableMapping)theEObject;
				T result = caseTableMapping(tableMapping);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JPAMappingPackage.COLUMN_MAPPING: {
				ColumnMapping columnMapping = (ColumnMapping)theEObject;
				T result = caseColumnMapping(columnMapping);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JPAMappingPackage.JOIN_MAPPING: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Jpa Mapping Config</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Jpa Mapping Config</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseJpaMappingConfig(JpaMappingConfig object) {
		return null;
	}
